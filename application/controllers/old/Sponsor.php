...
class Sponsor extends CI_Controller {
    ...
    public function __construct(){
        ...
        $this->load->model('productModel');
          ...
          // $this->load->model('sponsorGaleryModel');
    ...
    public function index($id = null){
        ...
        $config = array();
        $config["base_url"] = base_url() . "sponsor/page/";
        $total_row = $this->sponsorModel->record_count();
        ...
        $data["sponsorsSekunder"] = $this->sponsorModel->fetch_data($config["per_page"], $id)->result();
        ...
        $whereSpon['spo_type'] = 1;
        $sponsorPr = $this->sponsorModel->get_sponsors($whereSpon)->result();
        $data['sponsorsPr'] = $sponsorPr;

        $whereCont['con_id'] = 1;
        $contact = $this->contactModel->get_contacts($whereCont)->row_array();
        $data['contact'] = $contact;

        // $whereSpon['spo_type'] = 2;
        // $sponsor = $this->sponsorModel->get_sponsors($whereSpon)->result();
        // $data['sponsorsSekunder'] = $sponsor;
        $sponsor = $this->sponsorModel->get_sponsors()->result();
        $data['sponsors'] = $sponsor;

        // print_r($data);
        $this->twig->display('front/sponsor', $data);
