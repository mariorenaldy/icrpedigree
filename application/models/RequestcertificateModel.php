...
class RequestcertificateModel extends CI_Model {
    ...
    public function search_requests($like, $where, $offset = 0, $limit = 0){
        ...
        $this->db->join('kennels AS k1','k1.ken_id = requests_certificate.req_kennel_id AND k1.ken_member_id = m1.mem_id');
        $this->db->join('members AS m2','m2.mem_id = requests_certificate.req_old_member_id');
        $this->db->join('kennels AS k2','k2.ken_id = requests_certificate.req_old_kennel_id AND k2.ken_member_id = m2.mem_id');
