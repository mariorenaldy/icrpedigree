...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 align-items-center">
                    <h3 class="text-center text-primary">Add Service</h3>  
                    <form id="formService" class="form-horizontal" action="<?= base_url(); ?>Services/validate_add" method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" placeholder="Name" name="ser_name" value="<?php echo set_value('ser_name'); ?>">
                            </div>
                        </div>
                        <div class="input-group mb-3">
                            <label class="control-label col-md-2">Price</label>
                            <div class="col-md-10">
                                <input class="form-control" type="number" placeholder="Price" name="ser_price" value="<?php echo set_value('ser_price'); ?>">
                            </div>
                        </div>
                        <div class="input-group mb-3">
    ...
    <script>
        $('#buttonSubmit').on("click", function(e){
            e.preventDefault();
            $('#formService').attr('action', "<?= base_url(); ?>marketplace/Services/validate_add").submit();
        });
