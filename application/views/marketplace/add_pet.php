...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 align-items-center">
                    <h3 class="text-center text-primary">Add Pet</h3>  
                    <form id="formPet" class="form-horizontal" action="<?= base_url(); ?>Pets/validate_add" method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" placeholder="Name" name="pet_name" value="<?php echo set_value('pet_name'); ?>">
                            </div>
                        </div>
                        <div class="input-group mb-3">
                            <label class="control-label col-md-2">Price</label>
                            <div class="col-md-10">
                                <input class="form-control" type="number" placeholder="Price" name="pet_price" value="<?php echo set_value('pet_price'); ?>">
                            </div>
                        </div>
                        <div class="input-group mb-3">
    ...
    <script>
        $('#buttonSubmit').on("click", function(e){
            e.preventDefault();
            $('#formPet').attr('action', "<?= base_url(); ?>marketplace/Pets/validate_add").submit();
        });
