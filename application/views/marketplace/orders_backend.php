        ...
        <div class="row">            
            <div class="col-md-12">                          
                ...
                <div class="search-container my-3 sticky-top">
                    <form action="<?= base_url().'marketplace/Orders/search_list'?>" method="post">
                        <div class="input-group">
                            <div class="col-md-6">
                                <input type="text" class="form-control" placeholder="Invoice/Product's name" name="keywords" value="<?= set_value('keywords') ?>">
                            </div>
                            <div class="col-md-1 ms-1">
                                <button type="submit" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Search Order"><i class="fa fa-search"></i></button>
                            </div>
                        </div>
                    </form>
                </div>
