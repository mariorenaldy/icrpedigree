        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 align-items-center">
                    <h3 class="text-center text-primary">Add Canine Notes</h3>  
                    <form id="formCanine" class="form-horizontal" action="<?= base_url(); ?>backend/Caninenote/validate_add" method="post">
