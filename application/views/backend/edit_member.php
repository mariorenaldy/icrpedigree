        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 align-items-center">
                    <form class="form-horizontal" action="<?php echo base_url(); ?>backend/Members/validate_edit" method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="password" placeholder="New Password" name="new_password" value="<?= set_value('new_password'); ?>">
                            </div>
                        </div>
                        <div class="input-group mb-3">
                        ...
                        <div class="input-group mb-5">
                            ...
                            <div class="col-md-10">
                                <?php
                                    ...
                                    echo form_dropdown('mem_kennel_id', $ken, set_value('mem_kennel_id'), 'class="form-control"');
                                ?>
                            </div>
                        </div>
