        ...
        <div class="row">            
            <div class="col-md-12">                          
                ...
                <div class="search-container">
                    <form action="<?= base_url().'backend/Requestpro/search'?>" method="post">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body text-danger">
                        ...
                        <?php if ($this->session->flashdata('reject')){ ?>
                            <div class="row">
                                <div class="col-12">Become Pro has been rejected</div>
                            </div>
                        <?php } ?>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-success">
                            <?php if ($this->session->flashdata('approve')){ ?>
                                <div class="row">
                                    <div class="col-12">Become Pro has been approved</div>
                                </div>
                            <?php } ?>
                        </div>
                        <div class="modal-footer justify-content-center">
