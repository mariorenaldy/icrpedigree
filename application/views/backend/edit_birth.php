...
<body>
    ...
    <main class="container">
        ...
        <header class="d-flex flex-column align-items-center">
            <h2 class="fw-bold">Edit Birth</h2>
        </header>
        <div class="container">
            <div class="row">            
                <div class="col-md-12 align-items-center">                          
                    <form id="formBirth" class="form-horizontal" action="<?= base_url(); ?>backend/Births/validate_edit" method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" placeholder="Male Amount" name="bir_male" value="<?= set_value('bir_male'); ?>">
                            </div>
                        </div>
                        <div class="input-group mb-3">
                            <label for="bir_female" class="control-label col-md-2">Female</label>
                            <div class="col-md-10">
                                <input class="form-control" type="text" placeholder="Female Amount" name="bir_female" value="<?= set_value('bir_female'); ?>">
                            </div>
                        </div>
                        <div class="input-group mb-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <div class="col-md-10">
                                <textarea class="form-control" placeholder="Description" id="bir_note" name="bir_note" value="<?php echo set_value('bir_note'); ?>"></textarea>
                            </div>
                        </div>
    ...
    <script>
        ...
        $('#buttonSubmit').on("click", function(e){
            e.preventDefault();
            $('#formBirth').attr('action', "<?= base_url(); ?>backend/Births/validate_edit").submit();
        });
