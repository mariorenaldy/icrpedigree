                        ...
                        <div class="input-group mb-5">
                            ...
                            <div class="col-md-10">
                                <?php
                                    ...
                                    if (!$mode)
                                        echo form_dropdown('can_kennel_id', $ken, $canine->can_kennel_id, 'class="form-control", id="can_kennel_id"');
                                    else
                                        echo form_dropdown('can_kennel_id', $ken, null, 'class="form-control", id="can_kennel_id"');
                                ?>
                            </div>
                        </div>
                        <hr/>
