...
<body>
    ...
    <main class="container">
        ...
        <header class="d-flex flex-column align-items-center">
            <h2 class="fw-bold">Edit Canine</h2>
        </header>
        <div class="container">
            <div class="row">
                <div class="col-md-12 align-items-center">
                    <form id="formCanine" class="form-horizontal" action="<?php echo base_url(); ?>backend/Canines/validate_edit" method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-group mb-5">
                            <label class="control-label col-md-2">Breeder</label>
                            <div class="col-md-10">
                                <input class="form-control" type="text" placeholder="Breeder">
                            </div>
                        </div>
                        <hr />
                        ...
                        <div class="input-group mb-3">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" placeholder="Registration Number" name="can_reg_number" value="<?php echo set_value('can_reg_number'); ?>">
                            </div>
                        </div>
                        <div class="input-group mb-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <div class="col-md-10">
                                <textarea class="form-control" placeholder="Note" id="can_app_note" name="can_app_note" value="<?php echo set_value('can_app_note'); ?>"></textarea>
                            </div>
                        </div>
    ...
    <script>
        ...
        $('#buttonSubmit').on("click", function(e) {
            e.preventDefault();
            $('#formCanine').attr('action', "<?= base_url(); ?>backend/Canines/validate_edit").submit();
        });
