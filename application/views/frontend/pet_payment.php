...
<body class="text-white text-break">
    ...
    <main class="container">
        <figure class="figure w-25">
            <?php if ($pets->pet_photo != '-' &&  $pets->pet_photo != null){ ?>
                <img src="<?= base_url('uploads/pets/'.$pets->pet_photo) ?>" class="figure-img img-fluid rounded" style="max-height:300px;" alt="pet">
            <?php } else{ ?>
                <img src="<?= base_url('assets/img/pet.jpg') ?>" class="figure-img img-fluid rounded" style="max-height:300px;" alt="pet">
            <?php } ?>
        ...
        <form id="mainForm" class="form-horizontal" method="post" enctype="multipart/form-data">
            ...
            <div class="text-center">
                ...
                <button class="btn btn-danger" type="button" onclick="back(<?= $pets->pet_id ?>)">Kembali</button>
            </div>
        </form>
    </main>
    ...
    <script type="text/javascript">
        ...
        function back(id){
            window.location = "<?= base_url(); ?>frontend/Marketplace/pet_detail/"+id;
        }
    </script>
</body>
