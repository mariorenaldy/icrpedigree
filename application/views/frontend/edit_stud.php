...
<head>
    <title>Request Pengubahan Data Pacak</title>
...
<body class="text-white text-break">
    ...
    <main class="container">
        <header class="d-flex flex-column align-items-center">
            <h2 class="fw-bold text-warning">Request Pengubahan Data Pacak</h2>
        </header>
        <div class="container">
            <div class="row">            
                    ...
                    <form id="formStud" class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <div class="col-md-10">
                                ...
                                ?> -->
                                <select id="stu_sire_id" name="stu_sire_id" class="form-control"></select>
                            </div>
                        </div>
                        <div class="input-group mb-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <div class="col-md-10">
                                ...
                                ?> -->
                                <select id="stu_dam_id" name="stu_dam_id" class="form-control"></select>
                            </div>
                        </div>
    ...
    <script>
        ...
        $('#buttonSubmit').on("click", function(e){
            e.preventDefault();
            $('#formStud').attr('action', "<?= base_url(); ?>frontend/Studs/validate_edit").submit();
        });
