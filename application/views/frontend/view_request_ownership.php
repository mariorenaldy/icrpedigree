...
<head>
    ...
    <title><?= lang('owner_report_list'); ?></title>
...
<?php $this->load->view('frontend/layout/navbar'); ?>
    <div class="container">
        <div class="row">            
            <div class="col-sm-12">                          
                <h3 class="text-center text-warning"><?= lang('owner_report_list'); ?></h3>
                    ...
                    <form action="<?= base_url().'frontend/Requestownershipcanine/search'?>" method="post">
                        <div class="input-group my-3">
                            ...
                            <div class="col-sm-1 ms-1">
                                <button type="submit" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="<?= lang('owner_search_dog'); ?>"><i class="fa fa-search"></i></button>
                            </div>
                        </div>
                    </form>
                </div>
                <div class="row my-3">
                    <div class="col-sm-12">
                        <button type="button" class="btn btn-warning" onclick="add()" data-toggle="tooltip" data-placement="top" title="<?= lang('owner_report'); ?>"><i class="fa fa-plus"></i></button>
                    </div>
                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-success">
                            <?php if ($this->session->flashdata('add_success')){ ?>
                                <div class="row">
                                    <div class="col-12"><?= lang('owner_report_success'); ?></div>
                                </div>
                            <?php } ?>
                        </div>
