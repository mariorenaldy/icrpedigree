    ...
    <div class="container mt-5" style="margin-bottom: 10vh;">
        ...
        <div class="row">            
            <div class="col-md-12">                          
                ...
                <div class="mt-4 mb-4">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-add-canine"><i class="fa fa-plus"></i></button><span> Tambah Lahir</span>
                </div>

                <div class="row">
                    <div class="col-md"><b>Foto</b></div>
                    <div class="col-md"><b>Nama</b></div>
                ...
                <?php foreach ($births AS $b){ ?>
                    <div class="row">
                        <div class="col-md">
                            <?php if ($b->bir_photo != '-'){ ?>
                                <img src="<?= base_url('uploads/births/'.$b->bir_photo) ?>" class="img-fluid img-thumbnail" alt="canine">
                            <?php } else{ ?>
                        ...
                        <div class="col-md">
                            <?php if ($b->stat_name == 'Dalam Pemrosesan'){ ?>
                            ...
                            <?php } else if($b->stat_name == 'Disetujui'){ ?>
