...
<head>
    <title><?= lang("can_req_cert_complain"); ?></title>
...
<body class="text-white text-break">
    ...
    <main class="container">
        <div class="container">
            <h3 class="text-center text-warning"><?= lang("can_req_cert_complain"); ?></h3>
            <div class="row">            
                <div class="col-sm-12 align-items-center">                          
                    <form id="mainForm" class="form-horizontal" action="<?= base_url(); ?>frontend/Requestcertificate/validate_complain" method="post" enctype="multipart/form-data">
                        <div class="mb-1">
                            <?php if (!$mode){ ?>
                        ...
                        <div class="mb-1">
                            <span class="d-inline-block" style="width: 200px;"><?= lang("can_cert_date"); ?></span>
                            <span><?= $request->req_created_at ?></span>
                        </div>
                        <div class="mb-1">
                            <span class="d-inline-block" style="width: 200px;"><?= lang("can_cert_desc"); ?></span>
                            <span><?= $request->req_desc?></span>
                        </div>
                        <div class="mb-1">
                            <span class="d-inline-block" style="width: 200px;"><?= lang("can_cert_arrived_date"); ?></span>
                            <span><?= $request->req_arrived_date?></span>
                        </div>
                        ...
                        <div class="text-center">
                            ...
                            <button class="btn btn-danger" type="button" onclick="window.location = '<?= base_url() ?>frontend/Requestcertificate'"><?= lang("common_back"); ?></button>
                        </div>
                    </form>
                </div>
            </div>
