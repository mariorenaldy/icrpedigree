...
<head>
    <title>Pengubahan Data Canine</title>
...
<body class="text-white text-break">
    ...
    <main class="container">
        <header class="d-flex flex-column align-items-center">
            <h2 class="fw-bold text-warning">Pengubahan Data Canine</h2>
        </header>
        <div class="container">
            <div class="row">            
                <div class="col-md-12 align-items-center">                          
                    <form class="form-horizontal" action="<?= base_url(); ?>frontend/Canines/validate_edit" method="post" enctype="multipart/form-data">
