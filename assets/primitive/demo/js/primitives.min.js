/*
 Basic Primitives Diagram v3.7.4
...
primitives.common.ConnectorOffbeat.prototype.draw=function(a,b,c,d,e,f,g,h,i,j,k,l,n,m){var s,q,p,r,x,v,u,t,n=f=0,y=null,w,z;w=a.getPolyline(b);x=[];switch(i){case 1:x=[-e/2,e/2];z=!1;break;case 0:x=[0];z=!1;break;case 2:x=[0],z=!0}s=Math.max(l?g.width:0,5*e);if(c.right()+s<d.left()||c.left()>d.right()+s)if(c.left()>d.right()?(p=new primitives.common.Point(c.left(),c.verticalCenter()),r=new primitives.common.Point(d.right(),d.verticalCenter())):(p=new primitives.common.Point(c.right(),c.verticalCenter()),
r=new primitives.common.Point(d.left(),d.verticalCenter())),l&&(c.left()>d.right()?(f=7,n=3):(f=3,n=7)),q=new primitives.common.Rect(p,r),t=p.y<=r.y,u=p.x<r.x,q.height<q.width){q.height<2*e&&q.offset(0,t?2*e:0,0,t?0:2*e);h=0;for(s=x.length;h<s;h+=1)v=x[h],a.addInverted(function(c){c=c.getPolyline(b);c.addSegment(new primitives.common.MoveSegment(p.x,p.y+v));c.addSegment(new primitives.common.QuadraticArcSegment(q.horizontalCenter(),(t?q.top():q.bottom())+v,r.x,r.y+v));z&&c.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))})},
h||0==i),w.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))});l&&(i=g.width<2*(q.width/5)?primitives.common.QuadraticArcSegment.prototype.offsetPoint(p.x,p.y,q.horizontalCenter(),t?q.top():q.bottom(),r.x,r.y,0.5):new primitives.common.Point(p.x,t?q.top():q.bottom()),y=new primitives.common.Rect(i.x+(u?e:-g.width-e),t?i.y-g.height-e:i.y+e,g.width,g.height))}else{h=0;for(s=x.length;h<s;h+=1)v=x[h],a.addInverted(function(c){c=c.getPolyline(b);c.addSegment(new primitives.common.MoveSegment(p.x,
p.y+v));c.addSegment(new primitives.common.QuadraticArcSegment(q.horizontalCenter()+v*(t!=u?1:-1),(t?q.top():q.bottom())+v,q.horizontalCenter()+v*(t!=u?1:-1),q.verticalCenter()+v));c.addSegment(new primitives.common.QuadraticArcSegment(q.horizontalCenter()+v*(t!=u?1:-1),(t?q.bottom():q.top())+v,r.x,r.y+v));z&&c.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))})},h||0==i),w.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))});l&&(y=new primitives.common.Rect(q.horizontalCenter()+
(t!=u?e:-(e+g.width)),q.verticalCenter()-g.height/2,g.width,g.height))}else if(c.verticalCenter()<d.top()||c.verticalCenter()>d.bottom()){u=c.x<h.width/2;p=new primitives.common.Point(u?c.right():c.left(),c.verticalCenter());r=new primitives.common.Point(u?d.right():d.left(),d.verticalCenter());q=new primitives.common.Rect(p,r);q.offset(10*e,0,10*e,0);t=p.y<=r.y;h=0;for(s=x.length;h<s;h+=1)v=x[h],a.addInverted(function(c){c=c.getPolyline(b);c.addSegment(new primitives.common.MoveSegment(p.x,p.y+v));
c.addSegment(new primitives.common.QuadraticArcSegment(u?q.right()+v*(t?-1:1):q.left()-v*(t?-1:1),q.verticalCenter(),u?d.right():d.left(),d.verticalCenter()-v));z&&c.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))})},h||0==i),w.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))});l&&(n=f=u?3:7,i=primitives.common.QuadraticArcSegment.prototype.offsetPoint(p.x,p.y,u?q.right():q.left(),q.verticalCenter(),r.x,r.y,0.5),y=new primitives.common.Rect(i.x+(u?
e/2:-e/2-g.width),i.y-g.height/2,g.width,g.height))}else{p=new primitives.common.Point(c.horizontalCenter(),c.top());r=new primitives.common.Point(d.horizontalCenter(),d.top());q=new primitives.common.Rect(p,r);q.offset(0,7*e,0,0);u=p.x<r.x;h=0;for(s=x.length;h<s;h+=1)v=x[h],a.addInverted(function(c){c=c.getPolyline(b);c.addSegment(new primitives.common.MoveSegment(p.x+v,p.y));c.addSegment(new primitives.common.QuadraticArcSegment(q.horizontalCenter(),q.top()-v*(u?-1:1),d.horizontalCenter()-v,d.top()));
z&&c.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))})},h||0==i),w.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))});l&&(n=f=1,i=primitives.common.QuadraticArcSegment.prototype.offsetPoint(p.x,p.y,q.horizontalCenter(),q.top(),r.x,r.y,0.5),y=new primitives.common.Rect(i.x-g.width/2,i.y-(j+g.height),g.width,g.height))}if(l)switch(k){case 0:y=this._getLabelPosition(c.x,c.y,c.width,c.height,y.width,y.height,j,f);break;case 2:y=this._getLabelPosition(d.x,
d.y,d.width,d.height,y.width,y.height,j,n)}null!=m&&m(y)};primitives.common.ConnectorStraight=function(){};primitives.common.ConnectorStraight.prototype=new primitives.common.BaseShape;
primitives.common.ConnectorStraight.prototype.draw=function(a,b,c,d,e,f,g,h,i,j,k,l,n,m){var s,q,p,r,x,v=e/2,u=null,t=0,y=0,w=this;r=new primitives.common.Vector(c.centerPoint(),d.centerPoint());c.loopEdges(function(a,b){s=a.getIntersectionPoint(r,!0,1);t=b;return null!=s});d.loopEdges(function(a,b){q=a.getIntersectionPoint(r,!0,1);y=b;return null!=q});if(null!=s&&null!=q){var z=new primitives.common.Vector(s,q);n.getOffset(z,function(c,d,e){z.offset((c*f-(d-1)*f/2)*e);s=z.from;q=z.to;switch(i){case 1:x=
new primitives.common.Vector(q.clone(),s.clone());x.offset(v);w._drawLine(a,b,x.from,x.to,!1);x=new primitives.common.Vector(s.clone(),q.clone());x.offset(v);w._drawLine(a,b,x.from,x.to,!1);break;case 0:w._drawLine(a,b,s,q,!1);break;case 2:w._drawLine(a,b,s,q,!0)}if(l){switch(k){case 0:u=w._getLabelPositionBySnapPoint(s.x,s.y,g.width,g.height,j,t);break;case 1:p=w._betweenPoint(s,q);u=w._getLabelPositionBySnapPoint(p.x,p.y,g.width,g.height,j,3);break;case 2:u=w._getLabelPositionBySnapPoint(q.x,q.y,
g.width,g.height,j,y)}null!=m&&m.call(this,u)}})}};primitives.common.ConnectorStraight.prototype._drawLine=function(a,b,c,d,e){var f;a.addInverted(function(e){f=e.getPolyline(b);f.addSegment(new primitives.common.MoveSegment(c));f.addSegment(new primitives.common.LineSegment(d));f.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))})},!1);e&&(f=a.getPolyline(b),f.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))}))};
...
lineWidth:0,fillColor:g.lineColor,opacity:g.opacity||1});d.prototype.pushToSegment=function(a){this.segment.setPoint(a,this.pointIndex)};return i={paletteItem:g,arrowPaletteItem:j,addSegment:function(a){h.push(a)},addSegments:function(a){h=h.concat(a)},mergeTo:function(a){a.addSegments(h)},length:function(){return h.length},loop:b,loopReversed:function(a,b){var c,d;if(null!=b)for(c=h.length-1;0<=c&&(!(d=h[c])||!b.call(a,d,c));c-=1);},transform:function(a,c){b(this,function(b){null!=b.transform&&b.transform(a,
...
c=f.trim(c,g);var i=c.x,x=c.y;f=d.x;d=d.y;for(var v=g,g=new primitives.common.Polyline(j),u,t,e=[new primitives.common.Point(e,-v/2),new primitives.common.Point(0,0),new primitives.common.Point(e,v/2),new primitives.common.Point(3*(e/4),0)],y=Math.atan2(x-d,i-f),i=0,x=e.length;i<x;i+=1)v=e[i],u=v.x*Math.cos(y)-v.y*Math.sin(y),t=v.x*Math.sin(y)+v.y*Math.cos(y),v.x=u+f,v.y=t+d;g.addSegment(new primitives.common.MoveSegment(e[0].x,e[0].y));g.addSegment(new primitives.common.LineSegment(e[1].x,e[1].y));
...
(j.unshift(new primitives.common.Vector(i[1].clone(),i[0].clone())),i.length=1);switch(j.length){case 1:q=j[0];b=q.from.toString();h[b]=q;q.offset(a);q.from.context.pushToSegment(q.from);break;case 2:b=j[1],q=j[0],e(b,q,a,c,!1),j.length=1}})}c.addSegment(g)});0<j.length&&f(j,h,a,c);return c},toString:function(){return g.toString()},getStartPoint:function(){var a=null;0<h.length&&(a=h[0].getEndPoint());return a},getEndPoint:function(){var a=null;0<h.length&&(a=h[h.length-1].getEndPoint());return a},
clone:function(){var a,b,c=new primitives.common.Polyline(g),d=[],f;a=0;for(b=h.length;a<b;a+=1)f=h[a],d.push(f.clone());c.addSegments(d);return c}}};
...
primitives.common.ArrayReader.prototype.read=function(a,b,c,d){var e=[],f={},g={},h={},i,j,k,l,n,m;if(!b||!primitives.common.isArray(b))b=[];i=d.hash[c]||{};l=0;for(n=b.length;l<n;l+=1)j=b[l],k=this.containsUniqueItems?this.containsPrimitiveValues?j:j[this.uniquePropertyKey]:l,h.hasOwnProperty(k)||(h[k]=!0,m=i[k]||{},m=this.itemTemplate.read(m,j,c+"-"+l,d),e.push(m),f[k]=m,this.createSourceHash&&(g[k]=j));d.hash[c]=f;this.createSourceHash&&(d.sourceHash[c]=g);if(null==a||a.length!=e.length)d.isChanged=
...
this.highlightGravityRadius=40;this.selectedItems=[];this.hasSelectorCheckbox=0;this.selectCheckBoxLabel="Selected";this.neighboursSelectionMode=this.selectionPathMode=0;this.templates=[];this.defaultLabelAnnotationTemplate=this.defaultTemplateName=null;this.hasButtons=0;this.buttons=[];this.onCursorRender=this.onHighlightRender=this.onItemRender=this.onMouseDblClick=this.onMouseClick=this.onButtonClick=this.onSelectionChanged=this.onSelectionChanging=this.onCursorChanged=this.onCursorChanging=this.onHighlightChanged=
...
0;this.linesPalette=[];this.showCallout=!0;this.calloutPlacementOffset=100;this.defaultCalloutTemplateName=null;this.calloutfillColor="#000000";this.calloutBorderColor=null;this.calloutCornerRadius=this.calloutOffset=4;this.calloutPointerWidth="10%";this.calloutLineWidth=1;this.calloutOpacity=0.2;this.buttonsPanelSize=28;this.checkBoxPanelSize=this.groupTitlePanelSize=24;this.distance=3;this.scale=1;this.minimumScale=0.5;this.maximumScale=1;this.showLabels=0;this.labelSize=new primitives.common.Size(80,
...
k.fromItem));return a.SKIP}));for(l in d)if(d.hasOwnProperty(l)){e=d[l];e.sort(function(a,b){return b.toItems.length-a.toItems.length});for(n=0;n<e.length;n+=1){k=e[n];for(var m=a,s=c,q=k.fromItem,p=k.toItems,r=void 0,x=!0,v=null,u=void 0,t=void 0,y=void 0,w=void 0,z=[],t=0,y=p.length;t<y;t+=1)if(u=p[t],r=s.edge(q,u),null!=r){if(null==v)v=r.getFar(u);else if(v!=r.getFar(u)){x=!1;break}z.push(r.getNear(u))}else{x=!1;break}if(x&&(w=new primitives.famdiagram.FamilyItem({id:k.id,isVisible:!0,isLevelNeutral:!0,
isActive:!1,itemConfig:k}),m.bundleParents(v,z,w.id,w)?(w.levelGravity=2,x=!0):m.bundleChildren(v,z,w.id,w)?(w.levelGravity=1,x=!0):m.bundleParents(v,p,w.id,w)?(w.levelGravity=2,x=!0):m.bundleParents(v,p,w.id,w)&&(w.levelGravity=1,x=!0),x)){t=0;for(y=p.length;t<y;t+=1)u=p[t],r=s.edge(q,u),r.setFar(u,w.id)}}}}}var d=null,e=null;return{process:function(f){var g=b.getLogicalFamily(),h=a.getAnnotations(),g=g.clone();c(g,h);d=g;e=a.getMaximumId();if(f&&!g.validate())throw"References are broken in family structure!";
return!0},getNavigationFamily:function(){return d},getMaximumId:function(){return e}}};
primitives.famdiagram.AddSpousesTask=function(a,b){var c=null,d=null;return{process:function(e){var f=b.getLogicalFamily(),g=b.getMaximumId(),h=a.getItems(),i=f=f.clone(),j,k,l,n,m,s,q,p;l=0;for(n=h.length;l<n;l+=1){m=h[l];p=m.spouses.slice(0);s=0;for(q=p.length;s<q;s+=1)j=[m.id,p[s]],i.hasCommonChild(j)||(g+=1,k=new primitives.famdiagram.FamilyItem({id:g,isVisible:!1,isActive:!1,isLevelNeutral:!0,hideParentConnection:!0,hideChildrenConnection:!0,itemConfig:{title:"fake child #"+g,description:"This is fake child keeps spouses together."},
...
primitives.famdiagram.ItemsPositionsTask=function(a,b,c,d,e,f,g,h,i,j,k,l){function n(a){var b=new primitives.common.Rect(0,0,0,0),c,d,f,e,g;switch(G.orientationType){case 2:case 3:a.invert()}if(!C.isEmpty())switch(H.pageFitMode){case 0:case 4:case 5:c=[new primitives.orgdiagram.LevelVisibility(0,1)];b=m(c,0);break;default:c=[new primitives.orgdiagram.LevelVisibility(0,1)];d=[];switch(H.minimalVisibility){case 2:d.push(2);break;case 0:case 3:case 4:d.push(2),d.push(3)}C.loopLevelsReversed(this,function(a){var b;
for(b=0;b<d.length;b+=1)c.push(new primitives.orgdiagram.LevelVisibility(a,d[b]))});f=m(c,c.length-1);f.addRect(a);f.offset(0,0,5,5);g=e=a=null;b=m(c,0);if(!s(b,f)&&(a=0,b=m(c,c.length-1),s(b,f))){for(g=e=c.length-1;1<e-a;)g=Math.floor((e+a)/2),b=m(c,g),s(b,f)?e=g:a=g;e!==g&&(b=m(c,e))}}return b}function m(a,b){var c,d;D.treeLevelsPositions=[];C.loopLevels(this,function(){var a=new primitives.orgdiagram.TreeLevelPosition;a.currentvisibility=1;D.treeLevelsPositions.push(a)});for(c=0;c<=b;c+=1)d=a[c],
D.treeLevelsPositions[d.level].currentvisibility=d.currentvisibility;r();u();x();c=H.lineLevelShift;var f,e,g,k,i=d=0;f=8*J.linesWidth;switch(J.arrowsDirection){case 1:d=f;i=0;break;case 2:d=0,i=f}f=0;for(e=D.treeLevelsPositions.length;f<e;f+=1)g=D.treeLevelsPositions[f],k=h.getConnectorsStacksSizes(f),c+=g.setShift(c,v(g.actualVisibility),i,d,k.parentsStackSize);return new primitives.common.Rect(0,0,Math.round(p()),Math.round(q()))}function s(a,b){var c=!1;switch(H.pageFitMode){case 1:b.width>=a.width&&
(c=!0);break;case 2:b.height>=a.height&&(c=!0);break;case 3:b.height>=a.height&&b.width>=a.width&&(c=!0)}return c}function q(){var a=D.treeLevelsPositions[D.treeLevelsPositions.length-1];return a.shift+a.nextLevelShift}function p(){var a=0;C.loopLevels(this,function(b){var c=C.getLevelLength(b);0<c&&(b=C.getItemAtPosition(b,c-1),b=D.treeItemsPositions[b],a=Math.max(a,b.offset+b.actualSize.width+b.rightPadding))});return a}function r(){var a=k.getCursorTreeItem();D.treeItemsPositions={};C.loopLevels(this,
function(b){var c=D.treeLevelsPositions[b];C.loopLevelItems(this,b,function(b,d){var f=new primitives.orgdiagram.TreeItemPosition,e=l.isItemSelected(b)?1:!d.isVisible?4:0,g=j.getTemplateParams(b);f.actualVisibility=0===e?c.currentvisibility:e;f.setSize(a==b,g,H,G);D.treeItemsPositions[b]=f})})}function x(){var a,b;C.loopLevels(this,function(c){var d=D.treeLevelsPositions[c];d.shift=0;d.depth=0;d.actualVisibility=4;b=a=null;C.loopLevelItems(this,c,function(c){c=D.treeItemsPositions[c];d.depth=Math.max(d.depth,
c.actualSize.height);switch(c.actualVisibility){case 2:case 3:case 4:b=!b?c.actualSize.height:Math.min(b,c.actualSize.height);break;default:a=!a?c.actualSize.height:Math.min(a,c.actualSize.height)}d.actualVisibility=Math.min(d.actualVisibility,c.actualVisibility)});null==a&&(a=d.depth);null!=b&&b>a&&(a=b);switch(H.verticalAlignment){case 0:d.horizontalConnectorsDepth=a/2;break;case 1:d.horizontalConnectorsDepth=d.depth/2;break;case 2:d.horizontalConnectorsDepth=d.depth-a/2}})}function v(a){var b=
0;switch(a){case 1:b=H.normalLevelShift;break;case 2:b=H.dotLevelShift;break;case 3:case 4:b=H.lineLevelShift}return b}function u(){var a,b;a=0;for(b=D.treeLevelsPositions.length;a<b;a+=1)D.treeLevelsPositions[a].currentOffset=0;var c=C,d=I.getPlanarFamily(C),f=[],e,g={};a=0;c.loopLevels(this,function(b){c.loopLevelItems(this,b,function(e,k,h){if(!g.hasOwnProperty(e)){var i=d.countChildren(e);if(0<i){var j=new t(b,a);a+=1;j.addTop(h);d.loopChildren(this,e,function(a){j.addBottom(c.getItemPosition(a));
1==i&&d.loopParents(this,a,function(a){j.addTop(c.getItemPosition(a));g[a]=j;return d.SKIP});return d.SKIP});f.push(j);g[e]=j}}})});var k={},h=[],j=0,l,m;a=0;for(b=f.length;a<b;a+=1)if(e=f[a],l=e.topMiddle(),m=e.bottomMiddle(),null!=l&&null!=m){l=c.getItemAtPosition(e.level,l);var n=c.getItemAtPosition(e.level+1,m);m=k[l];null==m&&(m=new y(j),j+=1,m.add(e.level,l),k[l]=m,h.push(m));m.add(e.level+1,n);k[n]=m}c.loopLevels(this,function(a){c.loopLevelItems(this,a,function(b){var c=k[b];null==c&&(c=new y(j),
j+=1,c.add(a,b),k[b]=c,h.push(c))})});var s=new primitives.common.dependencies;c.loopLevels(this,function(a){var b=null;c.loopLevelItems(this,a,function(a){a=k[a];null!=b&&s.add(b,a.id,new w(null));b=a.id})});a=0;for(b=f.length;a<b;a+=1)e=f[a],e.loopDependencies(function(a,b,d,f,e){a=c.getItemAtPosition(b,a);f=c.getItemAtPosition(e,f);s.add(k[a].id,k[f].id,new w(d?a:f))});var q={},p=0;s.loopTopoForward(this,function(a){var b=0;s.loopBackward(this,a,function(c,d){var f=z(h[c],h[a],d.itemToMeasure);
b=Math.max(b,q[c]+f)});q[a]=b;p=Math.max(p,b)});var G={};a=0;for(b=f.length;a<b;a+=1)e=f[a],e.getRightPosition(this,function(a,b){var d=c.getItemAtPosition(a,b);G[k[d].id]=!0});s.loopTopoBackward(this,function(a){if(!G.hasOwnProperty(a)){var b=null;s.loopForward(this,a,function(c,d){var f=z(h[a],h[c],d.itemToMeasure);b=null==b?q[c]-f:Math.min(b,q[c]-f)});null!=b&&(q[a]=b)}});var u={};s.loopTopoBackward(this,function(a){var b=p;s.loopForward(this,a,function(c,d){var f=z(h[a],h[c],d.itemToMeasure);
b=Math.min(b,q[c]-f)});u[a]=b});var r={};a=0;for(b=f.length;a<b;a+=1)e=f[a],e.getLeftPosition(this,function(a,b){var d=c.getItemAtPosition(a,b);r[k[d].id]=!0});s.loopTopoForward(this,function(a,b){r.hasOwnProperty(a)||(b=null,s.loopBackward(this,a,function(c,d){var f=z(h[c],h[a],d.itemToMeasure);b=null==b?u[c]+f:Math.max(b,u[c]+f)}),null!=b&&(u[a]=b))});for(var A in q)q.hasOwnProperty(A)&&(q[A]=(q[A]+u[A])/2);var B=null;s.loopTopoForward(this,function(a,b,c){var b=h[a],d=q[a];if(0==c)b.loop(this,
function(a){a=D.treeItemsPositions[a];i.getInterval(a.actualVisibility);a=d-a.actualSize.width/2;B=null==B?a:Math.min(a,B)});else return!0});var B=B||0,J;b=0;for(e=h.length;b<e;b+=1)m=h[b],J=q[m.id]||0,m.loop(this,function(a){var a=D.treeItemsPositions[a],b=i.getInterval(a.actualVisibility)/2;a.leftPadding=b;a.rightPadding=b;a.offset=J-a.actualSize.width/2-B})}function t(a,b){this.id=b;this.level=a;this.bottomRight=this.bottomLeft=this.topRight=this.topLeft=null;this.topItems={};this.bottomItems=
...
this.topLeft):this.bottomLeft!=this.bottomRight&&b.call(a,this.level+1,this.bottomLeft)};this.getRightPosition=function(a,b){this.topLeft!=this.topRight?b.call(a,this.level,this.topRight):this.bottomLeft!=this.bottomRight&&b.call(a,this.level+1,this.bottomRight)}}function y(a){this.id=a;this.items={};this.maximum=this.minimum=null;this.add=function(a,b){this.items[a]=b;this.minimum=null!=this.minimum?Math.min(this.minimum,a):a;this.maximum=null!=this.maximum?Math.max(this.maximum,a):a};this.loop=
function(a,b){for(var c=this.items,d=this.minimum;d<=this.maximum;d+=1)b.call(a,c[d],d)}}function w(a){this.itemToMeasure=a}function z(a,b,c){var d=0;if(null==c)for(var f=Math.max(a.minimum,b.minimum),c=Math.min(a.maximum,b.maximum);f<=c;f+=1)d=Math.max(d,A(a.items[f],b.items[f]));else d=A(c,null);return d}function A(a,b){var c=0;if(null!=a)var d=D.treeItemsPositions[a],f=i.getInterval(d.actualVisibility)/2,c=c+(d.actualSize.width/2+f);null!=b&&(d=D.treeItemsPositions[b],f=i.getInterval(d.actualVisibility)/
2,c+=d.actualSize.width/2+f);return c}function B(){C.loopLevels(this,function(a){var b=D.treeLevelsPositions[a];C.loopLevelItems(this,a,function(a){D.treeItemsPositions[a].setPosition(b,H,G)})})}var D={treeItemsPositions:{},treeLevelsPositions:[],panelSize:null},I,C,G,J,H,E;return{process:function(){var k;H=d.getOptions();G=c.getOptions();J=e.getOptions();f.getOptions();I=g.getLogicalFamily();C=h.getTreeLevels();D.treeLevelsPositions=[];D.treeItemsPositions={};k=a.getOptimalPanelSize();E=b.getOptions();
k.scale(1/E.scale);k=new primitives.common.Rect(0,0,k.width,k.height);D.panelSize=n(k);B();return!0},getTreeLevelsPositions:function(){return D.treeLevelsPositions},getItemsPositions:function(){return D.treeItemsPositions},getItemPosition:function(a){return D.treeItemsPositions[a]},getContentSize:function(){return D.panelSize}}};
primitives.famdiagram.LevelsTask=function(a,b,c){var d,e,f,g,h;function i(a){var b,c,f,e,g,h,i,n,q=[],t,y,u,x,M,P,Z,aa,ga,ha,ja,X=[],ia;if(0<a.hasNodes()){ja={};y=0;ia=[];a.loopRoots(this,function(b){var c=u=new primitives.famdiagram.Family(y),d,f=[],e,g,b=a.node(b),f=s(b.id,null,c.id,b.level,b.itemConfig);f.hideParentConnection=!0;f.isVisible=b.isVisible;f.isActive=b.isActive;f.hideParentConnection=b.hideParentConnection;f.hideChildrenConnection=b.hideChildrenConnection;c.items.push(f);ja[b.id]=
!0;b.familyId=c.id;for(f=m(b,a,ja,c);0<f.length;){e=[];b=0;for(d=f.length;b<d;b+=1)g=f[b],e=e.concat(m(g,a,ja,c));f=e}X.push(u);ia.push(u);y+=1});ia.sort(function(a,b){var c=a.items[0].level,d=b.items[0].level;return c!=d?c-d:b.items.length-a.items.length});q=[];t={};if(0<X.length){g=primitives.common.graph();b=0;for(c=X.length;b<c;b+=1){u=X[b];f=0;for(e=u.links.length;f<e;f+=1)h=u.links[f],n=a.node(h.fromItem).familyId,i=a.node(h.toItem).familyId,n!=i&&(g.addEdge(n,i,{weight:0}),g.edge(n,i).weight+=
1),X[i].backLinks.push(new primitives.famdiagram.FamLink(h.toItem,h.fromItem))}for(;q.length<X.length;){b=0;for(c=ia.length;b<c;b+=1)u=ia[b],t.hasOwnProperty(u.id)||(ga=g.getSpanningTree(u.id,function(a){return-a.weight}),null!=ga.node(u.id)?(ga.loopPostOrder(this,function(a,b,c){var b=X[a],d=X[c],f=[];null!=c&&(d.familyPriority+=b.familyPriority);f=[];ga.loopChildren(this,a,function(a){f.push(a)});f.sort(function(a,b){return X[a].familyPriority-X[b].familyPriority});ga.arrangeChildren(a,f)}),ga.loopPreOrder(this,
function(a){q.push(a);t[a]=!0})):(q.push(u.id),t[u.id]=!0))}}d+=1;n=s(d,null,null,v-1,null);n.hideParentConnection=!0;n.hideChildrenConnection=!0;n.title="internal root";n.isVisible=!1;n.isActive=!1;n.childIndex=0;e={};b=0;for(c=q.length;b<c;b+=1){u=X[q[b]];Z={};g=n;aa=0;i=u.links.concat(u.backLinks);for(f=0;f<i.length;f+=1)h=i[f],M=p.node(h.toItem),p.node(h.fromItem),!0===e[M.familyId]&&(x=u.items[0],P=M,P.level>=x.level&&p.loopParents(this,P.id,function(a,b){P=b;if(b.level<x.level)return!0}),Z[P.id]=
Z.hasOwnProperty(P.id)?Z[P.id]+1:1,aa<Z[P.id]&&(g=P,aa=Z[P.id]));f=u;h=void 0;i=f.items[0];M=null;M=g;for(h=g.level+1;h<i.level;h+=1)d+=1,M=s(d,M.id,null,h,null),M.title="shift",M.isVisible=!1,M.isActive=!1,M.hideParentConnection=!0,M.hideChildrenConnection=!0,f.items.push(M);i.hideParentConnection=!0;p.adopt(M.id,i.id,i);e[u.id]=!0}b={};for(ha in r)if(r.hasOwnProperty(ha)){c=p.node(ha);n=r[ha];e=0;for(g=n.length;e<g;e+=1)f=p.node(n[e]),l(b,f,c)}ha=j();k(p,b,ha)}}function j(){var a={};p.loopPostOrder(this,
function(b,c,d){v=null!=v?Math.min(v,c.level):c.level;u=null!=u?Math.max(u,c.level):c.level;if(null!=d&&(a[d]||(a[d]={}),c=c.level-1,a[d][c]=a[d][c]?a[d][c]+1:1,null!=a[b]))for(c in a[b])a[b].hasOwnProperty(c)&&(a[d][c]=a[d][c]?a[d][c]+a[b][c]:a[b][c])});return a}function k(a,b,c){var d,f,e,g,h,k,i,j,l,m,n;a.loopLevels(this,function(s,q){var p=primitives.common.graph(),t={},u=null,y;i=[];a.loopChildren(this,q.id,function(c,e,g){var i;null==u&&(u=e);t[e.id]={};if(b.hasOwnProperty(e.id))for(i in k=
b[e.id],k)if(k.hasOwnProperty(i)){m=k[i];t[e.id][i]={};d=0;for(f=m.length;d<f;d+=1)h=m[d],y=h.commonParent==q.id?h.toParent:a.node(h.fromParent).childIndex<a.node(h.toParent).childIndex?"__right__":"__left__",e.id!=y&&(p.addEdge(e.id,y,{weight:0}),p.edge(e.id,y).weight+=1,null==t[e.id][i][y]&&(t[e.id][i][y]=0),t[e.id][i][y]+=1)}0<g&&p.addEdge(e.id,u.id,{weight:0})});if(null!=u){n=p.getGrowthSequence(function(a){return a.weight});0===n.length&&(n=[u.id]);var r=n,x=[],v,T,V,L,S,$,Y,ka,la,U,ca,Q,O,W,
ma,R,ba,ea,fa,da;T=new primitives.famdiagram.Slots;T.add(new primitives.famdiagram.Slot("__left__"));T.add(new primitives.famdiagram.Slot(null));T.add(new primitives.famdiagram.Slot("__right__"));V=0;T.loop(function(a){V+=1;a.position=V});for(v=0;v<r.length;v+=1)if(L=r[v],"__left__"!=L&&"__right__"!=L)for(ba in la=ka=Y=$=S=null,T.loop(function(a){var b,d,f,e;if(null==a.itemId){W=c[L];O=Q=ca=U=0;for(b in a.crossings)a.crossings.hasOwnProperty(b)&&(W&&null!=W[b]&&(U+=a.crossings[b]*W[b]),O+=a.crossings[b]);
...
a.crossings[ba]+ea[fa]:ea[fa];else return!0},R)):(da.balance-=1,R.balance+=1,T.loop(function(a){if(a.id!=R.id)if(a.id!=da.id)a.crossings[ba]=a.crossings[ba]?a.crossings[ba]+ea[fa]:ea[fa];else return!0},R))));T.loop(function(a){a=a.itemId;null!=a&&("__left__"!=a&&"__right__"!=a)&&x.push(a)});j=x;e=0;for(g=j.length;e<g;e+=1)l=a.node(j[e]),l.childIndex=e,i.push(l.id)}a.arrangeChildren(q.id,i)})}function l(a,b,c){var d=new primitives.famdiagram.ExtraGravity(b.level),f=new primitives.famdiagram.ExtraGravity(c.level);
p.zipUp(this,b.id,c.id,function(b,c,e,g){n(a,b,d);n(a,e,f);if(c==g)return d.commonParent=c,d.fromParent=b,d.toParent=e,f.commonParent=c,f.fromParent=e,f.toParent=b,!0})}function n(a,b,c){a.hasOwnProperty(b)||(a[b]={});null==a[b][c.level]&&(a[b][c.level]=[]);a[b][c.level].push(c)}function m(a,b,c,d){var f=[],e=null,g=null,h;1==b.countChildren(a.id)&&(e=b.firstChild(a.id));null!=x[e]?(g=x[e],null==r[g.id]&&(r[g.id]=[]),r[g.id].push(a.id),d.links.push(new primitives.famdiagram.FamLink(a.id,e))):(null!=
e&&(x[e]=a),b.loopChildren(this,a.id,function(e,g){if(c[g.id])throw"Many to many relations should not exist at this stage";f.push(g);h=s(g.id,a.id,d.id,g.level,g.itemConfig);h.hideParentConnection=g.hideParentConnection;h.hideChildrenConnection=g.hideChildrenConnection;h.isVisible=g.isVisible;h.isActive=g.isActive;d.items.push(h);c[g.id]=!0;g.familyId=d.id;return b.SKIP}));return f}function s(a,c,d,f,e){var g=new primitives.orgdiagram.OrgItem({});g.id=a;g.familyId=d;g.level=f;a=0;for(d=t.length;a<
d;a+=1)f=t[a],g[f]=null!=e&&void 0!==e[f]?e[f]:b[f];p.add(c,g.id,g);return g}function q(a,b,c,d,f){var e,g,h,k,i,j,l,m,n,s={},q,p,t;c.loopLevels(this,function(u){var y=new primitives.orgdiagram.TreeLevelConnectorStackSize;b[u]=y;n=[];c.loopLevelItems(this,u,function(b,c){var h=[],k=[],i;if(!s.hasOwnProperty(b)){s[b]=!0;c.hideChildrenConnection||h.push(b);i=f[b];if(null!=i){e=0;for(g=i.length;e<g;e+=1){var j=i[e];s[j]=!0;h.push(j)}}d.loopChildren(this,b,function(a,b){b.hideParentConnection||k.push(a)});
if(1<h.length||0<k.length)m=new primitives.orgdiagram.ConnectorBundle,m.fromLevel=u,m.fromItems=h,m.toItems=k,a.push(m),1<h.length&&n.push(m)}});if(0<n.length){t=primitives.common.pile();h=0;for(k=n.length;h<k;h+=1){m=n[h];p=q=null;i=0;for(j=m.fromItems.length;i<j;i+=1)l=c.getItemPosition(m.fromItems[i]),q=null!=q?Math.min(q,l):l,p=null!=p?Math.max(p,l):l;t.add(q,p,m)}y.parentsStackSize=t.resolve(this,function(a,b,c,d){c.fromOffset=d+1})}})}h=g=f=e=d=null;var p,r,x={},v,u,t="title description image itemTitleColor groupTitle groupTitleColor isActive hasSelectorCheckbox hasButtons templateName showCallout calloutTemplateName label showLabel labelSize labelOrientation labelPlacement minimizedItemShapeType".split(" "),
y=new primitives.orgdiagram.TreeLevelConnectorStackSize;return{process:function(){var b=a.getLogicalFamily(),b=b.clone();p=primitives.common.tree();d=a.getMaximumId();r={};x={};u=v=null;i(b);e=primitives.common.TreeLevels();f=primitives.common.TreeLevels();p.loopLevels(this,function(a,b,d){var g=c.getTemplateParams(a);e.addItem(d,a,b);null!=g&&(g.isActive&&b.isVisible)&&f.addItem(d,a,b)});g=[];h=[];q(g,h,e,p,r);return!0},getMaximumId:function(){return d},getTreeLevels:function(){return e},getActiveTreeLevels:function(){return f},
getBundles:function(){return g},getConnectorsStacksSizes:function(a){return h[a]||y}}};
...
primitives.famdiagram.RemoveLoopsTask=function(a,b){function c(a,b,c){var d,e,k,l,n,m,s,q,p;d=b.clone();b.loopTopo(this,function(a){d.removeNode(a)});if(d.hasNodes()){l=0;for(n=a.length;l<n;l+=1)if(e=a[l],null!=d.node(e.id)){p=[];d.loopParents(this,e.id,function(a){p.push(a);return d.SKIP});m=0;for(s=p.length;m<s;m+=1)d.removeRelation(p[m],e.id),b.removeRelation(p[m],e.id);c+=1;k=new primitives.famdiagram.FamilyItem({id:c,isVisible:!1,isActive:!0,isLevelNeutral:!0,hideParentConnection:!0,hideChildrenConnection:!0,
itemConfig:{title:"fake parent #"+c,description:"This is fake parent item was created by loops reversal."}});b.add([],k.id,k);b.adopt([k.id],e.id);m=0;for(s=p.length;m<s;m+=1)c+=1,e=new primitives.famdiagram.FamilyItem({id:c,isVisible:!1,isActive:!0,isLevelNeutral:!0,hideParentConnection:!0,hideChildrenConnection:!0,itemConfig:{title:"fake child #"+c,description:"This is fake child item was created by loops reversal."}}),b.add([k.id,p[m]],e.id,e);q=[];d.loopTopo(this,function(a){q.push(a)});m=0;for(s=
q.length;m<s;m+=1)d.removeNode(q[m])}}return c}var d=null,e=null;return{process:function(f){var g=b.getNavigationFamily(),h=b.getMaximumId(),i=a.getItems(),g=g.clone(),h=c(i,g,h,f);d=g;e=h;if(f&&!g.validate())throw"References are broken in family structure!";return!0},getLogicalFamily:function(){return d},getMaximumId:function(){return e}}};
...
primitives.orgdiagram.AlignDiagramTask=function(a,b,c,d,e,f,g,h,i){function j(a,b){var c=new primitives.common.Size(v.printPreviewPageSize),d,f,e;c.scale(1/t.scale);switch(x.orientationType){case 2:case 3:c.invert()}d=0;f=c.width;m.loopMerged(this,function(a){return q[a].actualPosition.x},function(b){var e=new primitives.orgdiagram.TreeItemPosition(q[b]);a[b]=e;e.actualPosition.left()+d<f&&e.actualPosition.right()+d>f&&(d+=f-e.actualPosition.left()-d+r.normalItemsInterval/2);e.actualPosition.translate(d,
0);e.actualPosition.left()>f&&(f+=c.width)});d=0;e=c.height;m.loopLevels(this,function(f){var g=new primitives.orgdiagram.TreeLevelPosition(p[f]);g.shift+d<e&&g.shift+g.depth+d>e&&(d+=e-g.shift-d+r.normalLevelShift/2);g.shiftDown(d);m.loopLevelItems(this,f,function(b){a[b].actualPosition.translate(0,d)});g.shift>e&&(e+=c.height);b.push(g)});return new primitives.common.Size(f+1,e+1)}var k={},l=[],n=null,m,s,q,p,r,x,v,u,t;return{process:function(){var y=new primitives.common.Size(h.getContentSize()),
w=new primitives.common.Size(f.getOptimalPanelSize());m=g.getTreeLevels();s=g.getActiveTreeLevels();q=h.getItemsPositions();p=h.getTreeLevelsPositions();r=b.getOptions();x=a.getOptions();v=e.getOptions();u=c.getOptions();t=d.getOptions();switch(x.orientationType){case 2:case 3:w.invert()}w.scale(1/t.scale);n=w;k=q;l=p;switch(r.pageFitMode){case 4:k={};l=[];n=j(k,l);break;case 5:n=new primitives.common.Size(y);break;default:n=new primitives.common.Size(y);if(y.width<w.width){k={};var z=y.width,A=w.width,
B;if(i)B=(A-z)/2;else switch(u.horizontalAlignment){case 1:B=0;break;case 2:B=A-z;break;case 0:B=(A-z)/2}var z=k,D;for(D in q)q.hasOwnProperty(D)&&(A=new primitives.orgdiagram.TreeItemPosition(q[D]),A.actualPosition.translate(B,0),z[D]=A);n.width=w.width}y.height<w.height&&(n.height=w.height)}switch(x.orientationType){case 2:case 3:n.invert()}return!0},getTreeLevelsPositions:function(){return l},getItemPosition:function(a){return k[a]},getItemsPositions:function(){return k},getContentSize:function(){return n},
getTreeItemForMousePosition:function(a,b,c){var d=null,f=null,e=null,g,h=t.scale,a=a/h,b=b/h;s.loopLevels(this,function(a){var c=l[a];if(b>c.shift+c.topConnectorShift&&b<=c.shift+c.connectorShift)return f=a,!0;g=Math.min(Math.abs(b-(c.shift+c.topConnectorShift)),Math.abs(b-(c.shift+c.connectorShift)));if(null==e||e>g)e=g,f=a});null!=f&&(d=s.binarySearch(this,f,function(c){c=k[c];switch(c.actualVisibility){case 1:if(c.actualPosition.contains(a,b))return 0;case 2:case 3:return a-c.actualPosition.horizontalCenter();
...
k[a];if(1==b.actualVisibility)if(e=Math.abs(c-b.actualPosition.horizontalCenter()),e<f||null==f)f=e,d=a;else return!0});if(null!=f)return!0});return d},getNextTreeItem:function(a,b){var c=a.id,d;s.loopFromItem(this,a,b,function(a){d=q[a];if(1==d.actualVisibility)return c=a,!0});return c}}};
primitives.orgdiagram.ApplyLayoutChangesTask=function(a,b,c,d,e,f,g){var h=null,i,j;return{process:function(){var k=b(),l=a(),n=f.getOptions().scale;i=d.getOptions();j=c.getOptions();var m=new primitives.common.Size(g.getContentSize());m.scale(1*n);k.mousePanel.css(m.getCSS());var s=new primitives.common.Size(g.getContentSize());k.placeholder.css(s.getCSS());l.resize("placeholder",s.width,s.height);switch(i.pageFitMode){case 5:h=new primitives.common.Size(m.width+25,m.height+25);h.cropBySize(j.autoSizeMaximum);
...
primitives.orgdiagram.CenterOnCursorTask=function(a,b,c,d,e,f,g){function h(a){var b=!1;j.transformRect(a.x,a.y,a.width,a.height,!0,this,function(a,c,d,f){b=new primitives.common.Rect(a,c,d,f)});return b}var i=null,j;return{process:function(){var k;k=a();var l=d.getCursorTreeItem(),n=e.getItemPosition(l),l=e.getContentSize(),m;m=g.getOptions().scale;i=c.getPlaceholderOffset();k.forceCenterOnCursor&&(j=f.getTransform(),null!=n&&(k=h(n.actualPosition),k.scale(m),l.scale(m),m=b.getScrollPanelSize(),
i=new primitives.common.Point(Math.max(Math.min(k.horizontalCenter()-m.width/2,l.width-m.width),0),Math.max(Math.min(k.verticalCenter()-m.height/2,l.height-m.height),0))));return!0},getPlaceholderOffset:function(){return i}}};
...
primitives.orgdiagram.DrawBackgroundAnnotationTask=function(a,b,c,d,e,f,g){function h(a,b,c){var d,e,g,h,r,x,v,u,t,y,w;d=0;for(e=a.length;d<e;d+=1)if(w=a[d],null!=w.items&&0<w.items.length){r=new primitives.common.Perimeter(i);r.transform=j;x=new primitives.orgdiagram.BackgroundAnnotationConfig;t=["opacity","lineWidth","borderColor","fillColor","lineType"];g=0;for(h=t.length;g<h;g+=1)y=t[g],r[y]=w.hasOwnProperty(y)?w[y]:x[y];i.activate("placeholder",2);v=[];u={};if(w.includeChildren){g=0;for(h=w.items.length;g<
h;g+=1)x=w.items[g],t=f.getItemPosition(x),null!=t&&(u[x]=!0,v.push(x),c.loopChildren(this,x,function(a){u[a]||(u[a]=!0,v.push(a))}))}else v=w.items;w=b.getMergedPerimeters(v);for(g=0;g<w.length;g+=1)r.draw(w[g])}}var i,j;return{process:function(){var c=d.getAnnotations(),f,n;i=a();i.reset("placeholder",2);0<c.length&&(j=b.getTransform(),f=g.getBackgroundManager(),n=e.getNavigationFamily(),h(c,f,n));return!1}}};
primitives.orgdiagram.DrawConnectorAnnotationTask=function(a,b,c,d,e,f,g,h){function i(a,b){var c,d,f,e,g,i,t,y,w=new primitives.common.PolylinesBuffer,z=primitives.orgdiagram.ConnectorAnnotationOffsetResolver(),A=0;switch(h){case 1:j.activate("placeholder",4);break;case 2:j.activate("placeholder",14)}c=0;for(d=a.length;c<d;c+=1)t=a[c],A=Math.max(A,t.lineWidth);c=0;for(d=a.length;c<d;c+=1)if(t=a[c],null!=t.fromItem&&null!=t.toItem&&(f=b(t.fromItem),e=b(t.toItem),null!=f&&null!=e)){f=f.actualPosition;
g=e.actualPosition;switch(t.connectorPlacementType){case 0:i=new primitives.common.ConnectorOffbeat;break;case 1:i=new primitives.common.ConnectorStraight}var B;k.transformRect(0,0,t.labelSize.width,t.labelSize.height,!1,this,function(a,b,c,d){B=new primitives.common.Size(c,d)});var D=null;k.transformRect(0,0,n.width,n.height,!1,this,function(a,b,c,d){D=new primitives.common.Size(c,d)});e=new primitives.common.PaletteItem({lineColor:t.color,lineWidth:t.lineWidth,lineType:t.lineType});var I=!primitives.common.isNullOrEmpty(t.label);
f=(new primitives.common.Rect(f)).offset(t.offset);g=(new primitives.common.Rect(g)).offset(t.offset);i.draw(w,e,f,g,3*t.lineWidth,6*A,B,D,t.connectorShapeType,4,t.labelPlacementType,I,z,function(a){I&&null!=a&&(k.transformRect(a.x,a.y,a.width,a.height,!0,this,function(b,c,d,f){a=new primitives.common.Rect(b,c,d,f)}),y=new primitives.common.RenderEventArgs,y.context=t,j.template(a.x,a.y,0,0,0,0,a.width,a.height,l.template(),l.getHashCode(),l.render,y,null))})}z.resolve();w.transform(k,!0);j.polylinesBuffer(w)}
var j,k,l,n;return{process:function(){j=a();k=b.getTransform();d.getOptions();l=g.getTemplate();n=new primitives.common.Size(f.getContentSize());switch(h){case 1:j.reset("placeholder",4);break;case 2:j.reset("placeholder",14)}i(e.getAnnotations(),f.getItemPosition);return!1}}};
primitives.orgdiagram.DrawConnectorsTask=function(a,b,c,d,e){return{process:function(){var f=a(),g=b.getGraph(),h=c.getOptions(),i=e.getPaletteManager();f.reset("placeholder",6);f.activate("placeholder",6);var j=new primitives.common.PolylinesBuffer,k=Math.round(h.elbowDotSize/2),l={},n={};g.loopNodes(this,null,function(a){g.loopNodeEdges(this,a,function(b,c){if(!l.hasOwnProperty(b)){var f=null;1>=c.fromOffset?f=i.getPalette(1):(i.selectPalette(c.fromOffset),f=i.getPalette(0));f=j.getPolyline(f);
if(d&&null!=c.dotId&&0!=h.elbowType&&!n.hasOwnProperty(c.dotId)){var e=j.getPolyline(f.arrowPaletteItem),g=c.dotId==c.from?c.polyline.getStartPoint():c.polyline.getEndPoint();e.addSegment(new primitives.common.DotSegment(g.x-k,g.y-k,2*k,2*k,k));n[c.dotId]=!0}e=null;null!=c.parentsArrowId&&1==h.arrowsDirection?e=c.parentsArrowId:null!=c.childrenArrowId&&2==h.arrowsDirection&&(e=c.childrenArrowId);null==e?c.from==a?c.polyline.clone().mergeTo(f):f.addInverted(c.polyline.clone()):(e==c.to?c.polyline.clone().mergeTo(f):
f.addInverted(c.polyline.clone()),f.addArrow(h.linesWidth,function(a){a.mergeTo(j.getPolyline(a.paletteItem))}))}});l[a]=!0});f.polylinesBuffer(j);return!1}}};
...
primitives.orgdiagram.DrawHighlightAnnotationTask=function(a,b,c,d,e,f,g,h,i,j,k,l,n){function m(a){var b,c,k,m,z,A,B=!0,D,I=i.getItemPosition(a),C=I.actualPosition;switch(I.actualVisibility){case 2:case 3:case 1:b=g.getItemOptions(a);switch(b.showCallout){case 2:B=!1;break;case 1:B=!1;break;default:B=r.showCallout}B?(s.activate("placeholder",12),q.transformRect(C.x,C.y,C.width,C.height,!0,this,function(g,q,C,E){var q=new primitives.common.Rect(g,q,C,E),g=new primitives.common.Point(q.horizontalCenter(),
q.verticalCenter()),C=e.getOptions().scale,E=new primitives.common.Point(j.getPlaceholderOffset()),B=i.getContentSize(),N=d.getOptimalPanelSize();E.scale(1/C);N.scale(1/C);C=new primitives.common.Rect(E.x,E.y,Math.min(N.width,B.width),Math.min(N.height,B.height));if(1!=I.actualVisibility||!C.overlaps(q)){z=!primitives.common.isNullOrEmpty(b.calloutTemplateName)?b.calloutTemplateName:!primitives.common.isNullOrEmpty(b.templateName)?b.templateName:!primitives.common.isNullOrEmpty(r.defaultCalloutTemplateName)?
r.defaultCalloutTemplateName:r.defaultTemplateName;A=h.getTemplate(z,h.DefaultWidgetTemplateName);q=A.templateConfig.itemSize;E=new primitives.common.Rect(g.x,g.y,q.width,q.height);switch(r.orientationType){case 0:case 1:E.y-=q.height/4;E.x=g.x<C.horizontalCenter()?E.x+r.calloutPlacementOffset:E.x-(r.calloutPlacementOffset+q.width);break;default:E.x-=q.width/4,E.y=g.y<C.verticalCenter()?E.y+r.calloutPlacementOffset:E.y-(r.calloutPlacementOffset+q.height)}E.x<C.x?E.x=C.x+5:E.right()>C.right()&&(E.x-=
E.right()-C.right()+5);E.y<C.y?E.y=C.y+5:E.bottom()>C.bottom()&&(E.y-=E.bottom()-C.bottom()+5);k=E;c=new primitives.common.Rect(k);c.addRect(g.x,g.y);c.offset(50);D=c.getCSS();D.display="inherit";D.visibility="inherit";x.calloutPlaceholder.css(D);g.x-=c.x;g.y-=c.y;k.x-=c.x;k.y-=c.y;m=new primitives.common.RenderEventArgs;m.context=f.getConfig(a);m.isCursor=l.getCursorTreeItem()==a;m.isSelected=n.isSelected(a);m.templateName=A.templateConfig.name;s.resize("calloutplaceholder",c.width,c.height);s.activate("calloutplaceholder",
15);s.template(k.x,k.y,k.width,k.height,0,0,k.width,k.height,A.itemTemplate.template(),A.itemTemplate.getHashCode(),A.itemTemplate.render,m,null);p.pointerPlacement=0;p.cornerRadius=r.calloutCornerRadius;p.offset=r.calloutOffset;p.opacity=r.calloutOpacity;p.lineWidth=r.calloutLineWidth;p.pointerWidth=r.calloutPointerWidth;p.borderColor=r.calloutBorderColor;p.fillColor=r.calloutfillColor;p.draw(g,k)}else x.calloutPlaceholder.css({display:"none",visibility:"hidden"})})):x.calloutPlaceholder.css({display:"none",
visibility:"hidden"});break;case 4:x.calloutPlaceholder.css({display:"none",visibility:"hidden"})}}var s,q,p=new primitives.common.Callout(b()),r,x;return{process:function(){var d=k.getHighlightTreeItem();s=b();s.reset("calloutplaceholder",15);null!==d&&(q=c.getTransform(),r=g.getOptions(),x=a(),m(d));return!1}}};
primitives.orgdiagram.DrawHighlightPathAnnotationTask=function(a,b,c,d,e){function f(a,b,c,d){var f,l,n,m,s,q,p,r,x,v,u,t,y;if(0<c.length){u=new primitives.common.PolylinesBuffer;switch(e){case 1:a.activate("placeholder",5);break;case 2:a.activate("placeholder",7)}var w={};f=0;for(l=c.length;f<l;f+=1)if(v=c[f],null!=v.items&&0<v.items.length&&(r=v.items.slice(0),s=r[0],d.hasNode(s))){n=1;for(m=r.length;n<m;n+=1)q=r[n],d.hasNode(q)&&(w.hasOwnProperty(s)?w[s].push(q):w[s]=[q],s=q)}var z={};for(t in w)z[t]=
{},w.hasOwnProperty(t)&&d.getShortestPath(this,t,w[t],function(a){return a.weight},function(a,b){z[t][b]=a});f=0;for(l=c.length;f<l;f+=1)if(v=c[f],n=new primitives.common.PaletteItem({lineColor:null!=v.color?v.color:b.highlightLinesColor,lineWidth:null!=v.lineWidth?v.lineWidth:b.highlightLinesWidth,lineType:null!=v.lineType?v.lineType:b.highlightLinesType,fillColor:null,opacity:v.opacity}),w=u.getPolyline(n),null!=v.items&&0<v.items.length&&(r=v.items.slice(0),s=r[0],d.hasNode(s))){n=1;for(m=r.length;n<
m;n+=1)if(q=r[n],d.hasNode(q)){p=z[s][q]||[];for(s=p.length-2;0<=s;s-=1)t=p[s+1],y=p[s],x=d.edge(t,y),x.from==t?x.polyline.clone().mergeTo(w):w.addInverted(x.polyline.clone()),v.showArrows&&(y==x.parentsArrowId||y==x.childrenArrowId)&&w.addArrow(v.lineWidth,function(a){a.mergeTo(u.getPolyline(a.paletteItem))});s=q}}a.polylinesBuffer(u)}}return{process:function(){var g=d.getGraph(),h=b.getOptions(),i=c.getAnnotations(),j=a();switch(e){case 1:j.reset("placeholder",5);break;case 2:j.reset("placeholder",
7)}f(j,h,i,g);return!1}}};
primitives.orgdiagram.DrawHighlightTask=function(a,b,c,d,e,f,g,h,i){function j(a){var b;k.activate("placeholder",8);var c=e.getItemPosition(a),g=c.actualPosition,j=f.getTemplateParams(a).template,r=j.templateConfig,x=r.highlightPadding;b=new primitives.common.RenderEventArgs;b.context=d.getConfig(a);b.isCursor=h.getCursorTreeItem()==a;b.isSelected=i.isSelected(a);b.templateName=r.name;l.transformRect(g.x,g.y,g.width,g.height,!0,this,function(a,d,f,e){var g=new primitives.common.Rect(0,0,Math.round(f),
Math.round(e));g.offset(x.left,x.top,x.right,x.bottom);1==c.actualVisibility?k.template(a,d,f,e,g.x,g.y,g.width,g.height,j.highlightTemplate.template(),j.highlightTemplate.getHashCode(),j.highlightTemplate.render,b,null):k.template(a,d,f,e,g.x,g.y,g.width-1,g.height-1,j.dotHighlightTemplate.template(),j.dotHighlightTemplate.getHashCode(),j.dotHighlightTemplate.render,b,null)})}var k,l;return{process:function(){var c=g.getHighlightTreeItem();k=a();k.reset("placeholder",8);null!=c&&(l=b.getTransform(),
j(c));return!1}}};
primitives.orgdiagram.DrawItemLabelsTask=function(a,b,c,d,e,f){function g(){var a,b,c,e,g,p,r,x=[];j.loopLevels(this,function(a){var c=[];j.loopLevelItems(this,a,function(a){var e=d.getItemOptions(a),g=f.getItemPosition(a),a=g.actualPosition;null!=e&&i.transformRect(a.x,a.y,a.width,a.height,!0,this,function(a,d,f,h){switch(g.actualVisibility){case 1:0==k.showLabels&&(b=new primitives.common.Label,b.text="dummy",b.position=new primitives.common.Rect(a,d,f,h),b.weight=1E4,b.labelType=1,c.push(b));break;
case 2:var i,j,l=null,m=k.labelOffset,s,p;if(!primitives.common.isNullOrEmpty(e.label)){switch(e.showLabel){case 0:switch(k.showLabels){case 0:switch(g.actualVisibility){case 3:case 2:l=new primitives.common.Label,l.labelType=0,l.weight=g.leftPadding+g.rightPadding}break;case 1:l=new primitives.common.Label,l.labelType=2,l.weight=1E4}break;case 1:l=new primitives.common.Label,l.weight=1E4,l.labelType=2}if(null!=l){l.text=e.label;s=null!=e.labelSize?e.labelSize:k.labelSize;l.labelOrientation=3!=e.labelOrientation?
e.labelOrientation:3!=k.labelOrientation?k.labelOrientation:0;p=0!=e.labelPlacement?e.labelPlacement:0!=k.labelPlacement?k.labelPlacement:1;switch(l.labelOrientation){case 0:i=s.width;j=s.height;break;case 1:case 2:j=s.width,i=s.height}switch(p){case 0:case 1:l.position=new primitives.common.Rect(a+f/2-i/2,d-m-j,i,j);switch(l.labelOrientation){case 0:l.horizontalAlignmentType=0;l.verticalAlignmentType=2;break;case 1:l.horizontalAlignmentType=1;l.verticalAlignmentType=1;break;case 2:l.horizontalAlignmentType=
2,l.verticalAlignmentType=1}break;case 2:case 11:l.position=new primitives.common.Rect(a+f+m,d-m-j,i,j);switch(l.labelOrientation){case 0:l.horizontalAlignmentType=1;l.verticalAlignmentType=2;break;case 1:l.horizontalAlignmentType=1;l.verticalAlignmentType=0;break;case 2:l.horizontalAlignmentType=2,l.verticalAlignmentType=2}break;case 3:l.position=new primitives.common.Rect(a+f+m,d+h/2-j/2,i,j);switch(l.labelOrientation){case 0:l.horizontalAlignmentType=1;l.verticalAlignmentType=1;break;case 1:l.horizontalAlignmentType=
0;l.verticalAlignmentType=0;break;case 2:l.horizontalAlignmentType=0,l.verticalAlignmentType=2}break;case 4:case 12:l.position=new primitives.common.Rect(a+f+m,d+h+m,i,j);switch(l.labelOrientation){case 0:l.horizontalAlignmentType=1;l.verticalAlignmentType=0;break;case 1:l.horizontalAlignmentType=2;l.verticalAlignmentType=0;break;case 2:l.horizontalAlignmentType=1,l.verticalAlignmentType=2}break;case 5:l.position=new primitives.common.Rect(a+f/2-i/2,d+h+m,i,j);switch(l.labelOrientation){case 0:l.horizontalAlignmentType=
0;l.verticalAlignmentType=0;break;case 1:l.horizontalAlignmentType=2;l.verticalAlignmentType=1;break;case 2:l.horizontalAlignmentType=1,l.verticalAlignmentType=1}break;case 6:case 10:l.position=new primitives.common.Rect(a-i-m,d+h+m,i,j);switch(l.labelOrientation){case 0:l.horizontalAlignmentType=2;l.verticalAlignmentType=0;break;case 1:l.horizontalAlignmentType=2;l.verticalAlignmentType=2;break;case 2:l.horizontalAlignmentType=1,l.verticalAlignmentType=0}break;case 7:l.position=new primitives.common.Rect(a-
i-m,d+h/2-j/2,i,j);switch(l.labelOrientation){case 0:l.horizontalAlignmentType=2;l.verticalAlignmentType=1;break;case 1:l.horizontalAlignmentType=0;l.verticalAlignmentType=2;break;case 2:l.horizontalAlignmentType=0,l.verticalAlignmentType=0}break;case 8:case 9:switch(l.position=new primitives.common.Rect(a-i-m,d-m-j,i,j),l.labelOrientation){case 0:l.horizontalAlignmentType=2;l.verticalAlignmentType=2;break;case 1:l.horizontalAlignmentType=1;l.verticalAlignmentType=2;break;case 2:l.horizontalAlignmentType=
2,l.verticalAlignmentType=0}}}}b=l;null!=b&&c.push(b)}})});x[a]=c});var v=[],u=[],t=[];0==k.showLabels&&(j.loopLevels(this,function(a){var b=x[a],c,d,f=!1;e=0;for(p=b.length;e<p;e+=1)c=b[e],null==d?d=new primitives.common.Rect(c.position):d.addRect(c.position),f=f||2==c.labelType;v[a]=d;u[a]=f}),j.loopLevelsReversed(this,function(a){var b=v[a-1],c=v[a];t[a]=!0;null!=b&&null!=c&&b.overlaps(c)&&(t[a]=!1)}),j.loopLevels(this,function(d){a=x[d];if(t[d]){e=0;for(p=a.length;e<p;e+=1)if(b=a[e],b.isActive)for(g=
e+1;g<p;g+=1)if(c=a[g],c.isActive)if(b.position.overlaps(c.position))if(b.weight>=c.weight)0==c.labelType&&(c.isActive=!1);else{0==b.labelType&&(b.isActive=!1);break}else break}}));h.activate("placeholder",10);r={"font-size":k.labelFontSize,"font-family":k.labelFontFamily,"font-style":k.labelFontStyle,"font-weight":k.labelFontWeight,"font-color":k.labelColor};j.loopLevels(this,function(a){if(1==k.showLabels||t[a]||u[a]){a=x[a];e=0;for(p=a.length;e<p;e+=1)if(b=a[e],b.isActive)switch(b.labelType){case 0:case 2:h.text(b.position.x,
...
primitives.orgdiagram.DrawMinimizedItemsTask=function(a,b,c,d,e,f){function g(){var a=new primitives.common.PolylinesBuffer,b={},c,f=new primitives.common.Marker,g,r,x,v,u,t,y,w,z,A;for(A in l)l.hasOwnProperty(A)&&(u=l[A],t=u.actualPosition,y=d.getItemOptions(A),i.transformRect(t.x,t.y,t.width,t.height,!0,this,function(d,h,i,l){switch(u.actualVisibility){case 2:w=e.getTemplateParams(A);z=w.template.templateConfig;x=r=g=null;v=0;null!=y&&(r=g=y.itemTitleColor,x=y.minimizedItemShapeType);g=g||z.minimizedItemBorderColor||
"#000080";r=r||z.minimizedItemFillColor||"#000080";null==x&&(x=null!==z.minimizedItemShapeType?z.minimizedItemShapeType:k.minimizedItemShapeType);v=null===z.minimizedItemCornerRadius?z.minimizedItemSize.width/2:z.minimizedItemCornerRadius;null==x||6==x?(c=a.getPolyline(new primitives.common.PaletteItem({lineColor:g,lineWidth:z.minimizedItemLineWidth,lineType:z.minimizedItemLineType,fillColor:r,opacity:z.minimizedItemOpacity})),c.addSegment(new primitives.common.DotSegment(d,h,i,l,v))):f.draw(a,x,
new primitives.common.Rect(d,h,i,l),new primitives.common.PaletteItem({lineColor:g,lineWidth:z.minimizedItemLineWidth,lineType:z.minimizedItemLineType,fillColor:r,opacity:z.minimizedItemOpacity}));break;default:j&&(g="#ff0000",b.hasOwnProperty(g)||(b[g]=new primitives.common.PaletteItem({lineColor:g,lineWidth:1,lineType:0,fillColor:g,opacity:1})),c=a.getPolyline(b[g]),c.addSegment(new primitives.common.DotSegment(d-1,h-1,2,2,1)))}}));h.activate("placeholder",9);h.polylinesBuffer(a)}var h,i,j=!1,k,
l;return{process:function(){h=a();i=b.getTransform();k=d.getOptions();l=f.getItemsPositions();h.reset("placeholder",9);g();return!1}}};
primitives.orgdiagram.DrawPrintPreviewTask=function(a,b,c,d,e,f){var g;return{process:function(){var b=c.getOptions(),i=f.getOptions();g=a();g.reset("placeholder",1);if(4==b.pageFitMode){var b=new primitives.common.Size(b.printPreviewPageSize),j,k,l=d.getContentSize(),n=e.getTemplate();b.scale(1/i.scale);g.activate("placeholder",1);for(i=0;(i+1)*b.width<l.width;){for(j=0;(j+1)*b.height<l.height;)k=g.template(i*b.width,j*b.height,b.width,b.height,0,0,b.width,b.height,n.template(),n.getHashCode(),n.render,
null,null),k.data({column:i,row:j}),j+=1;i+=1}}return!1}}};
primitives.orgdiagram.DrawShapeAnnotationTask=function(a,b,c,d,e,f,g,h){function i(a,b){var c,d,f,e,g,i,t,y,w,z,A,B;switch(h){case 1:c=j.activate("placeholder",3);break;case 2:c=j.activate("placeholder",13)}d=0;for(f=a.length;d<f;d+=1)if(A=a[d],null!=A.items&&0<A.items.length){y=new primitives.common.Rect;e=0;for(g=A.items.length;e<g;e+=1)t=b(A.items[e]),null!=t&&y.addRect(t.actualPosition);if(!y.isEmpty()){i=new primitives.common.Shape(j);t=new primitives.orgdiagram.ShapeAnnotationConfig;w="opacity cornerRadius shapeType offset lineWidth borderColor fillColor lineType labelSize labelOffset labelPlacement zOrderType".split(" ");
e=0;for(g=w.length;e<g;e+=1)z=w[e],i[z]=A.hasOwnProperty(z)?A[z]:t[z];i.position=y;i.orientationType=l.orientationType;i.panelSize=c.size;i.labelTemplate=n;i.hasLabel=null!=A.templateName||null!=A.label;B=new primitives.common.RenderEventArgs;B.context=A;B.templateName=i.labelTemplate;k.transformRect(y.x,y.y,y.width,y.height,!0,this,function(a,b,c,d){a=new primitives.common.Rect(a,b,c,d);i.draw(a,B)})}}}var j,k,l,n;return{process:function(){j=a();k=b.getTransform();l=d.getOptions();n=g.getTemplate();
switch(h){case 1:j.reset("placeholder",3);break;case 2:j.reset("placeholder",13)}i(e.getAnnotations(),f.getItemPosition);return!1}}};
primitives.orgdiagram.DrawTreeItemsTask=function(a,b,c,d,e,f,g,h,i,j,k,l){function n(){var a,b=h.getCursorTreeItem(),c,d,f;for(f in m)m.hasOwnProperty(f)&&(c=m[f],d=c.actualPosition,1==c.actualVisibility&&q.transformRect(d.x,d.y,d.width,d.height,!0,this,function(d,h,k,j){var l=g.getTemplateParams(f),m=l.template;a=new primitives.common.RenderEventArgs;a.context=e.getConfig(f);a.isCursor=f==b;a.isSelected=i.isSelected(f);a.templateName=m.templateConfig.name;s.activate("placeholder",12);s.template(d,
h,k,j,c.contentPosition.x,c.contentPosition.y,c.contentPosition.width,c.contentPosition.height,m.itemTemplate.template(),m.itemTemplate.getHashCode(),m.itemTemplate.render,a,{"border-width":m.templateConfig.itemBorderWidth});l.hasGroupTitle&&s.template(d,h,k,j,2,c.contentPosition.y,p.groupTitlePanelSize-4,c.contentPosition.height+2,v.template(),v.getHashCode(),v.render,a,null);l.hasSelectorCheckbox&&(s.activate("placeholder",16),s.template(d,h,k,j,c.contentPosition.x,j-(p.checkBoxPanelSize-4),c.contentPosition.width,
p.checkBoxPanelSize-4,x.template(),x.getHashCode(),x.render,a,null));l.hasButtons&&(s.activate("placeholder",16),s.template(d,h,k,j,k-(p.buttonsPanelSize-4),c.contentPosition.y,p.buttonsPanelSize-4,Math.max(c.contentPosition.height,j-c.contentPosition.y),r.template(),m.templateConfig.name+r.getHashCode(),r.render,l,null))}))}var m,s,q,p,r,x,v;return{process:function(){s=a();p=d.getOptions();m=f.getItemsPositions();q=b.getTransform();r=l.getTemplate();x=k.getTemplate();v=j.getTemplate();s.reset("placeholder",
12);s.reset("placeholder",16);n();return!1}}};primitives.orgdiagram.AnnotationLabelTemplateTask=function(){var a=null;return{process:function(){return!1},getTemplate:function(){null==a&&(a=new primitives.common.AnnotationLabelTemplate);return a}}};primitives.orgdiagram.ButtonsTemplateTask=function(){var a=null;return{process:function(){return!1},getTemplate:function(){null==a&&(a=new primitives.common.ButtonsTemplate);return a}}};
...
primitives.orgdiagram.ItemTemplateParamsTask=function(a,b,c){function d(a,b,c){var d=!1;switch(b){case 0:switch(c){case 0:d=a;break;case 1:d=!0;break;case 2:d=!1}break;case 1:d=!0;break;case 2:d=!1}return d}var e={};return{process:function(){var f=a.getOptions(),g=0<f.buttons.length,h=b.getCursorItem(),i=f.items,j,k;e={};j=0;for(k=i.length;j<k;j+=1){var l=i[j],n=new primitives.orgdiagram.TemplateParams,m=h==l.id,s=c.getTemplate(l.templateName,f.defaultTemplateName,c.DefaultWidgetTemplateName),q=s.templateConfig,
p=null!=q.buttons&&0<q.buttons.length;n.template=s;n.hasSelectorCheckbox=d(m,l.hasSelectorCheckbox,f.hasSelectorCheckbox);n.hasButtons=(g||p)&&d(m,l.hasButtons,f.hasButtons);n.hasGroupTitle=!primitives.common.isNullOrEmpty(l.groupTitle);n.isActive=l.isActive&&q.isActive;n.hasButtons&&(n.buttons=p?q.buttons:f.buttons);e[l.id]=n}return!0},getTemplateParams:function(a){return e[a]}}};
...
primitives.orgdiagram.BackgroundAnnotationManagerTask=function(a,b,c){function d(){var a=new primitives.common.perimeter.Manager,b,c,d,g,h,l,v,u,t,y,w,z,A,B,D;if(!i.isEmpty()&&(v=[],u=[],i.loopLevels(this,function(a){w=y=null;D=j[a];4!=D.actualVisibility&&(v.push(a),A=[],i.loopLevelItems(this,a,function(a){z=k[a];4!=z.actualVisibility&&(null!=w&&f(A,y,w,z),y=w,w=z)}),null!=w&&f(A,y,w,null),u.push(A))}),0<u.length)){t=[];h=[];b=0;for(c=u.length;b<c;b+=1)h=primitives.common.mergeSort([h,u[b]],null,
!0),t.push(h),h=u[b];t.push(primitives.common.mergeSort([u[b-1]],null,!0));h=[];b=0;for(c=t.length;b<c;b+=1){l={};A=t[b];d=0;for(g=A.length;d<g;d+=1)B=A[d],l[B]=d;h.push(l)}d=[];l=B=null;b=0;for(c=v.length;b<c;b+=1)g=v[b],null!=l&&e(d,b-1,h,t,j[B],l,j[l],j[g]),B=l,l=g;null!=l&&e(d,b-1,h,t,j[B],l,j[l],null);a.add(d)}return a}function e(a,b,c,d,f,e,h,j){var u=Math.floor(l.normalItemsInterval/2),t=null!=f?Math.floor(3*(f.shift+f.depth)/7+4*h.shift/7):h.shift-u,y=null!=j?Math.floor(3*(h.shift+h.depth)/
7+4*j.shift/7):h.shift+h.depth+u,w=null,z=null,A,B;i.loopLevelItems(this,e,function(f,e){A=k[f];4!=A.actualVisibility&&(null!=z&&g(a,c[b],c[b+1],d[b],d[b+1],t,y,w,z,A,B.id),w=z,z=A,B=e)});null!=z&&g(a,c[b],c[b+1],d[b],d[b+1],t,y,w,z,null,B.id)}function f(a,b,c,d){var f=Math.floor(l.normalItemsInterval/2),b=null!=b?Math.floor(3*b.actualPosition.right()/7+4*c.actualPosition.x/7):c.actualPosition.x-f,c=null!=d?Math.floor(3*c.actualPosition.right()/7+4*d.actualPosition.x/7):c.actualPosition.right()+f;
a.push(b);a.push(c)}function g(a,b,c,d,f,e,g,h,k,i,j){var w=[],z=primitives.common.perimeter.SegmentItem,A=Math.floor(l.normalItemsInterval/2),h=null!=h?Math.floor(3*h.actualPosition.right()/7+4*k.actualPosition.x/7):k.actualPosition.x-A,k=null!=i?Math.floor(3*k.actualPosition.right()/7+4*i.actualPosition.x/7):k.actualPosition.right()+A;w.push(new z(h,e,h,g));for(i=c[h]+1;i<=c[k];i+=1)w.push(new z(f[i-1],g,f[i],g));w.push(new z(k,g,k,e));for(i=b[k]-1;i>=b[h];i-=1)w.push(new z(d[i+1],e,d[i],e));a.push(new primitives.common.perimeter.Item(j,
w))}var h=null,i,j,k,l;return{process:function(){h=null;i=b.getTreeLevels();j=c.getTreeLevelsPositions();k=c.getItemsPositions();l=a.getOptions();return!0},getBackgroundManager:function(){null==h&&(h=d());return h}}};primitives.orgdiagram.CombinedContextsTask=function(a,b){return{process:function(){return!0},getConfig:function(c){return a.getConfig(c)||null!=b&&b.getConfig(c)}}};
primitives.orgdiagram.ConnectionsGraphTask=function(a,b,c,d,e){function f(a,b,c,d,f,e,g,h){this.polyline=c;this.from=a;this.to=b;this.weight=g||0;this.fromOffset=h||0;this.parentsArrowId=d;this.childrenArrowId=f;this.dotId=e}function g(a,b){var c=b.fromItems[0],d=b.toItems[0],e=v[c],g=v[d],h=x[b.fromLevel],k=new primitives.common.Polyline;e.actualPosition.x<g.actualPosition.x?s.transformPoints(e.actualPosition.right(),h.shift+h.horizontalConnectorsDepth,g.actualPosition.x,h.shift+h.horizontalConnectorsDepth,
...
1E3:10))}function h(a){this.bundleid=this.y=this.x=this.id=null;this.hasElbow=!1;this.visibility=this.elbowPoint2=this.elbowPoint1=null;this.isSquared=!0;for(var b in a)a.hasOwnProperty(b)&&(this[b]=a[b])}function i(){var a="_"+u;u+=1;return a}function j(a,b,c){var e=x[b.fromLevel],g=d.getConnectorsStacksSizes(b.fromLevel),l,j,m,n,p,u,H,E,K;E=0===q.connectorType;K=0<b.fromOffset?e.shift+e.connectorShift-e.levelSpace/2*(g.parentsStackSize-b.fromOffset+1):e.shift+e.connectorShift;g=[];if(0<b.fromItems.length){j=
b.fromItems;p=0;for(l=j.length;p<l;p+=1)m=j[p],n=v[m],m=new h({id:m,bundleid:i(),x:n.actualPosition.horizontalCenter(),y:n.actualPosition.bottom(),isSquared:!0,visibility:n.actualVisibility}),g.push(m);g.sort(function(a,b){return a.x-b.x})}l=[];if(0<b.toItems.length){H=!1;j=b.toItems;for(p=0;p<j.length;p+=1){m=j[p];r.getLevelIndex(m);n=v[m];u=!0;if(c)switch(n.actualVisibility){case 2:case 3:u=E}m=new h({id:m,bundleid:i(),x:n.actualPosition.horizontalCenter()+0,y:n.actualPosition.top(),isSquared:u,
visibility:n.actualVisibility});l.push(m);H=H||m.isSquared}l.sort(function(a,b){return a.x-b.x})}E=1==l.length?l[0].x:1==g.length?g[0].x:0<l.length&&0<g.length?(g[0].x+g[g.length-1].x+l[0].x+l[l.length-1].x)/4:0<l.length?(l[0].x+l[l.length-1].x)/2:(g[0].x+g[g.length-1].x)/2;var N=null;0<g.length&&(N=new h({id:i(),x:E,y:K}),k(a,N,g,!0,c,!0,b.fromOffset));var F=null;0<l.length&&(F=new h({id:i(),x:E,y:e.shift+e.connectorShift}),null!=N&&F.y==N.y&&(F=N),k(a,F,l,H,c,!1));null!=N&&(null!=F&&N.id!=F.id)&&
s.transformPoints(N.x,N.y,F.x,F.y,!0,this,function(b,c,d,e){var g=new primitives.common.Polyline;g.addSegment(new primitives.common.MoveSegment(b,c));g.addSegment(new primitives.common.LineSegment(d,e));a.addEdge(N.id,F.id,new f(N.id,F.id,g,null,null,null,0))})}function k(a,b,c,d,e,g,k){var i,j,m,n=[],p;if(d){n=[];d=0;for(j=c.length;d<j;d+=1)if(m=c[d],m.x<b.x&&!m.isSquared)n.push(m);else break;j=n.length;0<j&&(m=n[j-1],m=m.x==b.x?b:new h({id:m.bundleid,x:m.x,y:b.y}),l(a,m,n,!1));n=[];for(i=c.length-
1;i>=d;i-=1)if(m=c[i],m.x>b.x&&!m.isSquared)n.push(m);else break;j=n.length;0<j&&(m=n[j-1],m=m.x==b.x?b:new h({id:m.bundleid,x:m.x,y:b.y}),l(a,m,n,!1));for(n=d;n<=i;n+=1){m=c[n];j=q.bevelSize;2>j&&(j=0);if(e)switch(q.elbowType){case 2:case 3:0<j&&(Math.abs(b.x-m.x)>j&&Math.abs(b.y-m.y)>j)&&(m.hasElbow=!0,m.elbowPoint1=new primitives.common.Point(m.x,b.y+(b.y>m.y?-j:j)),m.elbowPoint2=new primitives.common.Point(m.x+(b.x>m.x?j:-j),b.y))}p=new primitives.common.Polyline;m.hasElbow?(s.transform3Points(m.elbowPoint2.x,
m.elbowPoint2.y,m.elbowPoint1.x,m.elbowPoint2.y,m.elbowPoint1.x,m.elbowPoint1.y,!0,this,function(a,b,c,d,f,e){switch(q.elbowType){case 2:p.addSegment(new primitives.common.MoveSegment(a,b));p.addSegment(new primitives.common.LineSegment(f,e));break;case 3:p.addSegment(new primitives.common.MoveSegment(a,b)),p.addSegment(new primitives.common.CubicArcSegment(a,b,c,d,f,e))}}),s.transformPoints(m.elbowPoint1.x,m.elbowPoint1.y,m.x,m.y,!0,this,function(a,b,c,d){p.addSegment(new primitives.common.LineSegment(c,
d))})):s.transformPoints(m.x,b.y,m.x,m.y,!0,this,function(a,b,c,d){p.addSegment(new primitives.common.MoveSegment(a,b));p.addSegment(new primitives.common.LineSegment(c,d))});j=m.x==b.x?b.id:m.bundleid;var u=4!==m.visibility;a.addEdge(j,m.id,new f(j,m.id,p,g&&u?m.id:null,!g&&u?m.id:null,null,u?1E3:10,k))}d=Math.max(d-1,0);i=Math.min(i+1,c.length-1);e=b;g=b.id;for(n=d;n<=i;n+=1)m=c[n],j=m.bundleid,m.x>e.x&&(p=new primitives.common.Polyline,s.transformPoints(e.x,b.y,null!=m.elbowPoint2?m.elbowPoint2.x:
m.x,b.y,!0,this,function(a,b,c,d){p.addSegment(new primitives.common.MoveSegment(a,b));p.addSegment(new primitives.common.LineSegment(c,d))}),a.addEdge(g,j,new f(g,j,p,null,null,g,Math.abs(m.x-e.x)/1E4,k)),e=m,g=j);e=b;g=b.id;for(n=i;n>=d;n-=1)m=c[n],j=m.bundleid,m.x<e.x&&(p=new primitives.common.Polyline,s.transformPoints(e.x,b.y,null!=m.elbowPoint2?m.elbowPoint2.x:m.x,b.y,!0,this,function(a,b,c,d){p.addSegment(new primitives.common.MoveSegment(a,b));p.addSegment(new primitives.common.LineSegment(c,
d))}),a.addEdge(g,j,new f(g,j,p,null,null,g,Math.abs(m.x-e.x)/1E4,k)),e=m,g=j)}else l(a,b,c,!0)}function l(a,b,c,d){var e,g,h,k,i;e=0;for(g=c.length;e<g;e+=1){k=c[e];i=new primitives.common.Polyline;s.transformPoint(b.x,b.y,!0,this,function(a,b){i.addSegment(new primitives.common.MoveSegment(a,b))});switch(q.connectorType){case 1:s.transformPoint(k.x,k.y,!0,this,function(a,b){i.addSegment(new primitives.common.LineSegment(a,b))});break;case 2:h=new primitives.common.Rect(b,k),d?b.x>h.x?s.transform3Points(h.right(),
h.verticalCenter(),h.x,h.verticalCenter(),h.x,h.bottom(),!0,this,function(a,b,c,d,f,e){i.addSegment(new primitives.common.CubicArcSegment(a,b,c,d,f,e))}):s.transform3Points(h.x,h.verticalCenter(),h.right(),h.verticalCenter(),h.right(),h.bottom(),!0,this,function(a,b,c,d,f,e){i.addSegment(new primitives.common.CubicArcSegment(a,b,c,d,f,e))}):b.x>h.x?s.transformPoints(h.x,h.y,h.x,h.bottom(),!0,this,function(a,b,c,d){i.addSegment(new primitives.common.QuadraticArcSegment(a,b,c,d))}):s.transformPoints(h.right(),
h.y,h.right(),h.bottom(),!0,this,function(a,b,c,d){i.addSegment(new primitives.common.QuadraticArcSegment(a,b,c,d))})}h=4!==k.visibility;a.addEdge(b.id,k.id,new f(b.id,k.id,i,null,h?k.id:null,h?1E3:10))}}var n=null,m,s,q,p,r,x,v,u;return{process:function(){m=a();s=b.getTransform();q=c.getOptions();p=d.getBundles();r=d.getTreeLevels();x=e.getTreeLevelsPositions();v=e.getItemsPositions();var f=primitives.common.graph(),h=m.activate("placeholder",6),k,i;k=u=0;for(i=p.length;k<i;k+=1){var l=p[k];l.isVertical?
j(f,l,h.hasGraphics):g(f,l)}n=f;return!0},getGraph:function(){return n}}};primitives.orgdiagram.IntervalsTask=function(a){var b={};return{process:function(){var c=a.getOptions();b[1]=c.normalItemsInterval;b[2]=c.dotItemsInterval;b[3]=c.lineItemsInterval;b[4]=c.lineItemsInterval;return!0},getInterval:function(a){return b[a]}}};
primitives.orgdiagram.ItemsPositionsTask=function(a,b,c,d,e,f,g,h,i,j,k,l,n){var m,s,q;function p(a){var b=new primitives.common.Rect(0,0,0,0),c,d,f,e,g;switch(E.orientationType){case 2:case 3:a.invert()}if(!C.isEmpty())switch(F.pageFitMode){case 0:case 4:case 5:c=[new primitives.orgdiagram.LevelVisibility(0,1)];b=r(c,0);break;default:c=[new primitives.orgdiagram.LevelVisibility(0,1)];d=[];switch(F.minimalVisibility){case 2:d.push(2);break;case 0:case 3:case 4:d.push(2),d.push(3)}C.loopLevelsReversed(this,
function(a){var b;for(b=0;b<d.length;b+=1)c.push(new primitives.orgdiagram.LevelVisibility(a,d[b]))});f=r(c,c.length-1);f.addRect(a);f.offset(0,0,5,5);g=e=a=null;b=r(c,0);if(!x(b,f)&&(a=0,b=r(c,c.length-1),x(b,f))){for(g=e=c.length-1;1<e-a;)g=Math.floor((e+a)/2),b=r(c,g),x(b,f)?e=g:a=g;e!==g&&(b=r(c,e))}}return b}function r(a,b){var c,d;m=[];C.loopLevels(this,function(){var a=new primitives.orgdiagram.TreeLevelPosition;a.currentvisibility=1;m.push(a)});for(c=0;c<=b;c+=1)d=a[c],m[d.level].currentvisibility=
d.currentvisibility;t();z();y();c=F.lineLevelShift;var f,e,g,h,k=d=0;f=8*K.linesWidth;switch(K.arrowsDirection){case 1:d=f;k=0;break;case 2:d=0,k=f}f=0;for(e=m.length;f<e;f+=1)g=m[f],h=i.getConnectorsStacksSizes(f),c+=g.setShift(c,w(g.actualVisibility),k,d,h.parentsStackSize);return new primitives.common.Rect(0,0,Math.round(u()),Math.round(v()))}function x(a,b){var c=!1;switch(F.pageFitMode){case 1:b.width>=a.width&&(c=!0);break;case 2:b.height>=a.height&&(c=!0);break;case 3:b.height>=a.height&&b.width>=
a.width&&(c=!0)}return c}function v(){var a=m[m.length-1];return a.shift+a.nextLevelShift}function u(){var a=0,b,c;b=0;for(c=m.length;b<c;b+=1)a=Math.max(a,m[b].currentOffset);return a+=F.normalItemsInterval}function t(){var a=l.getCursorTreeItem();s={};C.loopLevels(this,function(b){var c=m[b];C.loopLevelItems(this,b,function(b,d){var f=new primitives.orgdiagram.TreeItemPosition,e=n.isItemSelected(b)?1:d.visibility,g=k.getTemplateParams(b);f.actualVisibility=0===e?c.currentvisibility:e;f.setSize(a==
b,g,F,E);s[b]=f})})}function y(){var a,b;C.loopLevels(this,function(c){var d=m[c];d.shift=0;d.depth=0;d.actualVisibility=4;b=a=null;C.loopLevelItems(this,c,function(c){c=s[c];d.depth=Math.max(d.depth,c.actualSize.height);switch(c.actualVisibility){case 2:case 3:case 4:b=!b?c.actualSize.height:Math.min(b,c.actualSize.height);break;default:a=!a?c.actualSize.height:Math.min(a,c.actualSize.height)}d.actualVisibility=Math.min(d.actualVisibility,c.actualVisibility)});null==a&&(a=d.depth);null!=b&&b>a&&
(a=b);switch(F.verticalAlignment){case 0:d.horizontalConnectorsDepth=a/2;break;case 1:d.horizontalConnectorsDepth=d.depth/2;break;case 2:d.horizontalConnectorsDepth=d.depth-a/2}})}function w(a){var b=0;switch(a){case 1:b=F.normalLevelShift;break;case 2:b=F.dotLevelShift;break;case 3:case 4:b=F.lineLevelShift}return b}function z(){var a,b;a=0;for(b=m.length;a<b;a+=1)m[a].currentOffset=0;G.loopPostOrder(this,function(a,b){var c=s[a],d=c.actualVisibility,f=C.getLevelIndex(a),f=m[f],d=g.getInterval(0===
d?f.currentvisibility:d)/2,e,h,k,i,j,l,n,p;e=8*K.linesWidth;c.leftPadding=d+(0<f.currentOffset?d*b.relationDegree*F.cousinsIntervalMultiplier:0);c.rightPadding=d;0!=K.arrowsDirection&&(b.connectorPlacement&8&&(c.leftPadding+=e),b.connectorPlacement&2&&(c.rightPadding+=e));c.offset=f.currentOffset+c.leftPadding;f.currentOffset=c.offset+c.actualSize.width+c.rightPadding;if(G.hasChildren(a))if(c=A(b),0<c)D(b,c);else if(0>c&&(c=-c,B(b,c),h=null,k={},j=null,f=G.parent(b.id),null!==f&&(G.loopChildrenReversed(this,
f.id,function(a,c){if(c===b)h=[];else if(null!==h){var d=null,f=[],e,g,l,m;e=H[c.id];void 0===e&&(e=[]);e=e.slice();e.splice(0,0,c.id);g=0;for(l=e.length;g<l;g+=1)m=s[e[g]],f[g]=m.offset+m.actualSize.width+m.rightPadding;e=[];var n;g=J[b.id];void 0===g&&(g=[]);g=g.slice();g.splice(0,0,b.id);l=0;for(m=g.length;l<m;l+=1)n=s[g[l]],e[l]=n.offset-n.leftPadding;g=Math.min(f.length,e.length);for(l=0;l<g&&!(m=e[l]-f[l],d=null!==d?Math.min(d,m):m,0>=m);l+=1);i=Math.floor(d);k[c.id]=i;if(0<i)h.splice(0,0,c);
else return j=c,!0}}),0<h.length))){d=null;if(null!==j){l=[j];l=l.concat(h);l.push(b);d=[[j]];f=1;for(e=l.length;f<e;f+=1)n=l[f-1],p=l[f],2==n.gravity||1==p.gravity?d[d.length-1].push(p):d.push([p])}else d=[h.slice(0)],d[d.length-1].push(b);if(0<d.length){h=d[d.length-1];for(f=h.length-2;0<=f;f-=1)p=h[f],i=k[p.id],c=Math.min(i,c),B(p,c),D(p,c)}l=c/(d.length-1);for(e=d.length-2;0<e;e-=1){n=d[e];for(f=n.length-1;0<=f;f-=1)p=n[f],i=k[p.id],c=Math.min(e*l,Math.min(i,c)),B(p,c),D(p,c)}}})}function A(a){var b=
s[a.id],b=b.offset+b.actualSize.width/2,c=null,d,f,e;if(null===a.visualAggregatorId)switch(d=null,G.loopChildren(this,a.id,function(a,b){d=b;if(d.connectorPlacement&1)return!0}),f=s[d.id],e=null,G.loopChildrenReversed(this,a.id,function(a,b){e=b;if(e.connectorPlacement&1)return!0}),a=s[e.id],N.horizontalAlignment){case 1:c=f.offset+f.actualSize.width/2;break;case 2:c=a.offset+a.actualSize.width/2;break;case 0:c=(f.offset+a.offset+a.actualSize.width)/2}else a=s[a.visualAggregatorId],c=a.offset+a.actualSize.width/
2;return b-c}function B(a,b){var c=s[a.id];c.offset+=b;var d=m[C.getLevelIndex(a.id)];d.currentOffset=Math.max(d.currentOffset,c.offset+c.actualSize.width+c.rightPadding)}function D(a,b){var c,d;G.loopLevels(this,a.id,function(a){c=s[a];c.offset+=b;d=m[C.getLevelIndex(a)];d.currentOffset=Math.max(d.currentOffset,c.offset+c.actualSize.width);return!0})}function I(){C.loopLevels(this,function(a){var b=m[a];C.loopLevelItems(this,a,function(a){s[a].setPosition(b,F,E)})})}s={};m=[];q=null;var C,G,J,H,
E,K,N,F,M;return{process:function(){var g;F=d.getOptions();E=c.getOptions();K=e.getOptions();N=f.getOptions();C=i.getTreeLevels();G=h.getVisualTree();J=j.getLeftMargins();H=j.getRightMargins();m=[];s={};g=a.getOptimalPanelSize();M=b.getOptions();g.scale(1/M.scale);g=new primitives.common.Rect(0,0,g.width,g.height);q=p(g);I();return!0},getTreeLevelsPositions:function(){return m},getItemsPositions:function(){return s},getItemPosition:function(a){return s[a]},getContentSize:function(){return q}}};
...
primitives.orgdiagram.VisualTreeLevelsTask=function(a,b){function c(a,b,c,d){var f,e,g,h,p,r,x,v={},u,t,y;c.loopLevels(this,function(w){var z=new primitives.orgdiagram.TreeLevelConnectorStackSize;b[w]=z;x=[];c.loopLevelItems(this,w,function(b,f){var e=[];if(!v.hasOwnProperty(b)&&(f.connectorPlacement&4&&e.push(b),e=e.concat(f.partners),0<e.length)){r=new primitives.orgdiagram.ConnectorBundle;r.fromLevel=w;r.fromItems=e;r.toItems=[];for(var g=0,h=e.length;g<h;g+=1)v[e[g]]=r;d.loopChildren(this,b,function(a,
b){b.connectorPlacement&1&&r.toItems.push(a)});1<e.length&&x.push(r);(1<r.fromItems.length||0<r.toItems.length)&&a.push(r)}f.connectorPlacement&8&&(r=new primitives.orgdiagram.ConnectorBundle,r.isVertical=!1,r.fromLevel=w,r.fromItems=[b],r.toItems=[c.getPrevItem(b)],a.push(r));f.connectorPlacement&2&&(r=new primitives.orgdiagram.ConnectorBundle,r.isVertical=!1,r.fromLevel=w,r.fromItems=[b],r.toItems=[c.getNextItem(b)],a.push(r))});if(0<x.length){y=primitives.common.pile();f=0;for(e=x.length;f<e;f+=
1){r=x[f];t=u=null;g=0;for(h=r.fromItems.length;g<h;g+=1)p=c.getItemPosition(r.fromItems[g]),u=null!=u?Math.min(u,p):p,t=null!=t?Math.max(t,p):p;y.add(u,t,r)}z.parentsStackSize=y.resolve(this,function(a,b,c,d){c.fromOffset=d+1})}})}var d=null,e=null,f=null,g=null,h=new primitives.orgdiagram.TreeLevelConnectorStackSize;return{process:function(){var h=a.getVisualTree();d=primitives.common.TreeLevels();e=primitives.common.TreeLevels();h.loopLevels(this,function(a,c,f){var g=b.getTemplateParams(a);d.addItem(f,
...
primitives.orgdiagram.VisualTreeTask=function(a,b,c,d){function e(a,b,c){var e,g,r,z,A,B,D,I,C,G,J,H,E={},K,N={},F,M,P,Z={},aa;a.loopPostOrder(this,function(a,b,c,d){b.hasVisibleChildren=b.isVisible||b.hasVisibleChildren;null!=d&&(d.hasVisibleChildren=d.hasVisibleChildren||b.hasVisibleChildren)});a.loopLevels(this,function(f,h){var i,D,I;if(!d&&!h.hasVisibleChildren)return a.SKIP;i=c.node(f);i||(i=s({visibility:4,connectorPlacement:0,parentId:null,actualItemType:0},h),c.add(null,f,i));P=M=0;if(null!=
(B=c.indexOf(f)))M=B,P=c.countSiblings(f)-B-1;D=[];a.loopChildren(this,f,function(a,b){if(d||b.hasVisibleChildren){e=s({parentId:f,actualItemType:b.itemType},b);switch(i.actualItemType){case 7:case 8:case 6:switch(e.actualItemType){case 7:case 8:case 6:e.actualItemType=2;break;case 0:e.actualItemType=1}}switch(e.actualItemType){case 5:q(i,e),e.connectorPlacement=5,I=s({visibility:4}),c.add(I.id,e.id,e),e=I;case 8:case 2:g=c.parent(f);if(i.connectorPlacement&2)z=l(c,p.navigationFamily,i),c.add(g.id,
e.id,e,z+1),e.connectorPlacement=6,e.gravity=2;else if(i.connectorPlacement&8)A=n(c,p.navigationFamily,i),c.add(g.id,e.id,e,A),e.connectorPlacement=12,e.gravity=1;else switch(b.adviserPlacementType){case 2:z=l(c,p.navigationFamily,i);c.add(g.id,e.id,e,z+1);e.connectorPlacement=6;e.gravity=2;break;default:A=n(c,p.navigationFamily,i),c.add(g.id,e.id,e,A),e.connectorPlacement=12,e.gravity=1}switch(e.actualItemType){case 8:null!=i.parentId?q(c.node(i.parentId),e):q(i,e,!0);break;case 2:q(i,e)}break;case 4:q(i,
e),e.connectorPlacement=5,I=s({visibility:4}),c.add(I.id,e.id,e),e=I;case 1:null===i.visualAggregatorId&&m(c,i,!1);switch(b.adviserPlacementType){case 2:c.add(f,e.id,e,0);e.connectorPlacement=6;e.gravity=2;break;default:c.add(f,e.id,e),e.connectorPlacement=12,e.gravity=1}1==e.actualItemType&&q(i,e);break;case 0:D.push(e);q(i,e);break;case 7:case 6:g=c.parent(f);if(i.connectorPlacement&2)c.add(g.id,e.id,e,M),e.connectorPlacement=6,e.gravity=2;else if(i.connectorPlacement&8)c.add(g.id,e.id,e,c.countChildren(g.id)-
...
else switch(c.actualItemType){case 7:case 8:case 6:a.parentid(c.id)==f&&aa.push(c)}}),1<aa.length&&(Z[f]=aa)}E[f]=[];N[f]=[];var r=i,C=h.childrenPlacementType,w=E[f],G=N[f],J,H,K,F,U,ca,Q,O,W=4==r.visibility&&0===r.connectorPlacement;switch(b.horizontalAlignment){case 0:case 1:H=3;break;case 2:H=2}0===C&&(C=k(a,r)?0===b.leavesPlacementType?3:b.leavesPlacementType:0===b.childrenPlacementType?2:b.childrenPlacementType);J=r;null!==r.visualAggregatorId&&(J=c.node(r.visualAggregatorId));3==C&&3>D.length&&
(C=2);switch(C){case 2:C=0;for(F=D.length;C<F;C+=1)r=D[C],w=a.node(r.id),c.add(J.id,r.id,r),r.connectorPlacement=(w.hideParentConnection?0:1)|(w.hideChildrenConnection?0:4),0===C&&(r.relationDegree=1);break;case 3:F=Math.min(b.maximumColumnsInMatrix,Math.ceil(Math.sqrt(D.length)));U=Math.ceil(D.length/F);ca=Math.ceil(F/2);for(Q=0;Q<ca;Q+=1){H=J;for(O=0;O<U;O+=1){r=j(D,2*Q,O,F);C=j(D,2*Q+1,O,F);void 0===w[O]&&(w[O]=[],G[O]=[]);null!==r&&(0===Q&&(r.relationDegree=1),c.add(H.id,r.id,r),r.connectorPlacement=
(W?0:2)|4,r.gravity=2,G[O].push(r));if(null!==r||null!==C)K=s({visibility:4,connectorPlacement:W?0:5}),c.add(H.id,K.id,K),w[O].push(K);null!==C&&(c.add(H.id,C.id,C),C.connectorPlacement=(W?0:8)|4,C.gravity=1,G[O].push(C));H=K}}2<F&&(J.visualAggregatorId=null);break;case 1:C=0;for(F=D.length;C<F;C+=1){r=D[C];K=s({visibility:4,connectorPlacement:W?0:5});switch(H){case 2:c.add(J.id,r.id,r);c.add(J.id,K.id,K);r.connectorPlacement=(W?0:2)|4;r.gravity=2;break;case 3:c.add(J.id,K.id,K),c.add(J.id,r.id,r),
r.connectorPlacement=(W?0:8)|4,r.gravity=1}w[C]=[K];G[C]=[r];J=K}break;default:throw"Children placement is undefined!";}});a.loopPostOrder(this,function(a){var b=c.node(a),d,e,g;if(null!=b){d=N[a];e=E[a];G=h(c,b);if(0<G&&(b.visualDepth=G+1,null!==b.visualAggregatorId)){r=c.node(b.visualAggregatorId);g=c.hasChildren(r.id);for(B=0;B<G-1;B+=1)r=m(c,r,!g)}g=0;var k=c.parent(b.id),l,j,n;if(null!==k){l=c.indexOf(b.id);for(j=1;null!=(n=c.getChild(k.id,l+j));)if(n.connectorPlacement&8)g=Math.max(g,i(c,n)),
j+=1;else break;for(j=1;null!=(n=c.getChild(k.id,l-j));)if(n.connectorPlacement&2)g=Math.max(g,i(c,n)),j+=1;else break}G=g;if(1<G){b.visualDepth+=G-1;g=c.hasChildren(a);r=b;for(B=0;B<G-1;B+=1)r=m(c,r,!g)}J=[];B=0;for(D=d.length;B<D;B+=1){F=d[B];I=J[B]=0;for(C=F.length;I<C;I+=1)J[B]=Math.max(J[B],i(c,F[I]))}B=0;for(D=J.length;B<D;B+=1)if(H=J[B],1<H){I=0;for(C=e[B].length;I<C;I+=1)if(K=e[B][I],c.hasChildren(K.id))for(G=H;1<G;)K=m(c,K,!1),G-=1}null!=Z[a]&&f(c,b,Z[a])}})}function f(a,b,c){var d,e,f,h,
k=0,i=[],j,n;e=0;for(f=c.length;e<f;e+=1)d=c[e],k=Math.max(k,d.visualDepth);e=0;for(f=c.length;e<f;e+=1){d=c[e];j=g(a,d);h=1;for(n=d;null!=n.visualAggregatorId;)n=a.node(n.visualAggregatorId),n.connectorPlacement=5,h+=1;for(;h<k;)j=m(a,j,!1),h+=1;i.push(g(a,j).id)}n=g(a,b);if(a.hasChildren(n.id)){j=c[Math.floor(c.length/2)];if(1<c.length&&0===c.length%2){e=a.parent(j.id);f=l(a,p.navigationFamily,j);h=a.getChild(e.id,f).gravity||a.getChild(e.id,f+1).gravity;j=s({visibility:4,connectorPlacement:j.connectorPlacement&
10,gravity:h});a.add(e.id,j.id,j,f+1);for(h=1;h<k;)j=m(a,j,!1),j.connectorPlacement=0,h+=1}e=0;for(f=c.length;e<f;e+=1)d=c[e],p.navigationFamily.loopChildren(this,b.id,function(a,c){switch(c.actualItemType){case 5:case 2:case 4:case 1:break;default:b.id!=d.id&&q(d,c)}return p.navigationFamily.SKIP});j=g(a,j);a.moveChildren(n.id,j.id)}j.partners=i}function g(a,b){for(var c=b;null!=c.visualAggregatorId;)c=a.node(c.visualAggregatorId);return c}function h(a,b){var c=0;null!=b.visualAggregatorId&&a.loopLevels(this,
...
primitives.orgdiagram.BaseControl=function(a,b,c,d){function e(a){switch(a){case 1:f(!0,v);break;case 2:a=v;p.layout.forceCenterOnCursor=!1;p.tasks.process("HighlightItemOptionTask",null,a);p.graphics.end();break;default:null!=p.mouse&&p.mouse.destroy();j(p.layout);p.layout.element.find("."+p.name).remove();var a=p.layout,b=p.name,e=new primitives.common.Rect(0,0,a.element.outerWidth(),a.element.outerHeight()),r=new primitives.common.Rect(e),z=a.element.offset(),A;A=jQuery('<div tabindex="0"></div>');
A.css({position:"relative",overflow:"auto","-webkit-overflow-scrolling":"touch",top:"0px",left:"0px",width:e.width+"px",height:e.height+"px",padding:"0px","margin-bottom":"0px","margin-right":"0px","margin-top":-z.top+Math.floor(z.top)+"px","margin-left":-z.left+Math.floor(z.left)+"px"});A.addClass(b);e=jQuery("<div></div>");e.css({position:"absolute",overflow:"hidden",top:"0px",left:"0px"});e.addClass(b);e.css(r.getCSS());z=jQuery("<div></div>");z.css({position:"absolute",overflow:"hidden",top:"0px",
left:"0px"});z.addClass("placeholder");z.addClass(b);z.css(r.getCSS());r=jQuery("<div></div>");r.css({position:"absolute",overflow:"visible"});r.addClass("calloutplaceholder");r.addClass(b);r.css({top:"0px",left:"0px",width:"0px",height:"0px"});A.append(e);e.append(z);z.append(r);a.element.append(A);a.scrollPanel=A;a.mousePanel=e;a.placeholder=z;a.calloutPlaceholder=r;p.options.enablePanning&&(p.mouse=new primitives.common.Mouse,p.mouse.init(p.layout.element,{name:p.name,onMouseDrag:k,onMouseStop:l,
onMouseCapture:n}));a=p.layout;a.mousePanel.mousemove(function(a){var b=p.layout.mousePanel.offset(),c=a.pageX-b.left,b=a.pageY-b.top,d=p.tasks.getTask("CreateTransformTask"),e=p.tasks.getTask("HighlightItemOptionTask");if(!p.mouse||!p.mouse.isStarted())x=!1,e.hasHighlightEnabled()&&(c=d.getTreeItemForMousePosition(c,b,e.getGravityRadius()),m(a,c))}).click(function(a){if(!p.mouse||!p.mouse.isStarted()){var b=p.layout.mousePanel.offset(),c=a.pageX-b.left,e=a.pageY-b.top,f=p.tasks.getTask("CreateTransformTask"),
b=p.tasks.getTask("CursorItemOptionTask"),g=p.tasks.getTask("HighlightItemOptionTask"),c=f.getTreeItemForMousePosition(c,e,g.getGravityRadius()),h;null!==c&&!x&&(e=jQuery(a.target),e.hasClass(p.name+"button")||0<e.parent("."+p.name+"button").length?(h=e.hasClass(p.name+"button")?e:e.parent("."+p.name+"button"),h=h.data("buttonname"),h=d(p,null,c,h),q("onButtonClick",a,h)):"selectiontext"!==e.attr("name")&&("checkbox"===e.attr("name")?(b=(p.options.selectedItems||[]).slice(0),h=d(p,null,c,h),q("onSelectionChanging",
a,h),e=primitives.common.indexOf(b,c),0<=e?b.splice(e,1):b.push(c),p.options.selectedItems=b,q("onSelectionChanged",a,h)):(h=d(p,null,c,void 0),q("onMouseClick",a,h),!h.cancel&&b.hasCursorEnabled()&&(s(a,c),p.layout.scrollPanel.focus()))))}x=!1}).dblclick(function(a){var b;b=p.tasks.getTask("HighlightItemTask").getHighlightTreeItem();null!==b&&!x&&(b=d(p,null,b,void 0),q("onMouseDblClick",a,b));x=!1});a.scrollPanel.keydown(function(a){var b=p.tasks.getTask("HighlightItemTask"),c=p.tasks.getTask("HighlightItemOptionTask"),
d=p.tasks.getTask("CursorItemTask"),e=p.tasks.getTask("CursorItemOptionTask"),f=p.tasks.getTask("AlignDiagramTask"),g=p.tasks.getTask("CreateTransformTask").getTransform(),h=null,k,i=null,l=p.layout;c.hasHighlightEnabled()&&e.hasCursorEnabled()?(h=b.getHighlightTreeItem(),null===h&&(h=d.getCursorTreeItem())):c.hasHighlightEnabled()?h=b.getHighlightTreeItem():e.hasCursorEnabled()&&(h=d.getCursorTreeItem());if(null!=h){switch(a.which){case 13:e.hasCursorEnabled()&&(s(a,h),a.preventDefault(),l.scrollPanel.focus());
break;case 40:i=1;break;case 38:i=0;break;case 37:i=2;break;case 39:i=3}if(null!=i){for(b=!1;!b;){b=!0;i=g.getOrientation(i);switch(i){case 0:k=f.getNextLevelTreeItem(h,!1);break;case 1:k=f.getNextLevelTreeItem(h,!0);break;case 2:k=f.getNextTreeItem(h,!0);break;case 3:k=f.getNextTreeItem(h,!1)}null!=k&&(a.preventDefault(),c.hasHighlightEnabled()?m(a,k):e.hasCursorEnabled()&&s(a,k))}l.scrollPanel.focus()}}});p.tasks=c(g,h,i);p.graphics=primitives.common.createGraphics(p.options.graphicsType,p.layout.element);
p.graphics.debug=v;p.options.actualGraphicsType=p.graphics.graphicsType;f(!0,v)}}function f(a,b){var c;p.layout.forceCenterOnCursor=a;p.tasks.process("OptionsTask",null,b);p.graphics.end();a&&(c=p.tasks.getTask("CenterOnCursorTask"),c=c.getPlaceholderOffset(),p.layout.scrollPanel.scrollLeft(c.x),p.layout.scrollPanel.scrollTop(c.y))}function g(){return p.options}function h(){return p.graphics}function i(){return p.layout}function j(a){null!=a.mousePanel&&(a.mousePanel.unbind("mousemove"),a.mousePanel.unbind("click"),
a.mousePanel.unbind("dblclick"));null!=a.scrollPanel&&a.scrollPanel.unbind("keydown")}function k(a){var b=new primitives.common.Point(a.pageX,a.pageY),a=-b.x+r.x,b=-b.y+r.y,c=p.layout.scrollPanel;c.css("visibility","hidden");c.scrollLeft(a).scrollTop(b);c.css("visibility","inherit");return!1}function l(){x=!0}function n(a){var b=p.layout.scrollPanel;r=new primitives.common.Point(b.scrollLeft()+a.pageX,b.scrollTop()+a.pageY);return!0}function m(a,b){var c=!0,e;null!==b?b!==p.options.highlightItem&&
(e=d(p,p.options.highlightItem,b,void 0),p.options.highlightItem=b,q("onHighlightChanging",a,e),e.cancel?c=!1:(f(!1,!1),q("onHighlightChanged",a,e))):null!==p.options.highlightItem&&(e=d(p,p.options.highlightItem,null,void 0),p.options.highlightItem=null,q("onHighlightChanging",a,e),e.cancel?c=!1:(f(!1,!1),q("onHighlightChanged",a,e)));return c}function s(a,b){var c;b!==p.options.cursorItem&&(c=d(p,p.options.cursorItem,b,void 0),p.options.cursorItem=b,q("onCursorChanging",a,c),c.cancel||(f(!0,v),
q("onCursorChanged",a,c)))}function q(a,b,c){a=p.options[a];null!=a&&a(b,c)}var p={name:"orgdiagram",options:b,tasks:null,graphics:null,mouse:null,layout:{element:a,scrollPanel:null,mousePanel:null,placeholder:null,calloutPlaceholder:null,forceCenterOnCursor:!0}},r,x,v=!1;e();return{destroy:function(){j(p.layout);p.layout.element.find("."+p.name).remove();p.tasks=null;p.graphics=null},setOptions:function(a){for(var b in a)a.hasOwnProperty(b)&&(p.options[b]=a[b])},getOptions:g,setOption:function(a,
...
l;){n=k.segments.item(l);d.hasOwnProperty(n.oppositeKey)&&(j=d[n.oppositeKey],g.hasOwnProperty(j.id)&&!g[j.id]&&(g[j.id]=!0,j.segments.iterateBack(function(a){a.key!=n.oppositeKey&&k.segments.insertAfter(l,a.key,a)},n.oppositeKey,null),j.segments.iterateBack(function(a){k.segments.insertAfter(l,a.key,a)},null,n.oppositeKey)));j=k.segments;for(var m=n,s=j.nextKey(m.key),q=void 0;null!=m&&m.oppositeKey==(q=s||j.startKey());)null!=s&&(s=j.nextKey(s)),j.remove(m.key),j.remove(q),m=j.item(null!=s?j.prevKey(s):
j.endKey());l=s}}return b}}};
...
primitives.common.mergeSort=function(a,b,c){var d=null,e,f,g,h,i,j,k,l,n,m,s,q;switch(a.length){case 0:d=[];break;default:d=[];for(g=0;g<a.length;g+=1){e=a[g];f=[];j=d.length;k=e.length;i=h=0;s=n=m=l=null;0<j&&(l=d[h],m=!b?l:b(l));0<k&&(n=e[i],s=!b?n:b(n));for(q=null;h<j||i<k;)if(h>=j){if(!c||q!=n)f.push(n),q=n;i+=1;i<k&&(n=e[i],s=!b?n:b(n))}else if(i>=k){if(!c||q!=l)f.push(l),q=l;h+=1;h<j&&(l=d[h],m=!b?l:b(l))}else if(m<s){if(!c||q!=l)f.push(l),q=l;h+=1;h<j&&(l=d[h],m=!b?l:b(l))}else{if(!c||q!=n)f.push(n),
q=n;i+=1;i<k&&(n=e[i],s=!b?n:b(n))}d=f}}return d};primitives.common.binarySearch=function(a,b){var c=null,d,e,f=0,g=a.length-1,h,i;if(0<a.length&&(c=a[f],d=b(c),0<d))if(e=Math.abs(d),i=a[g],d=b(i),0<=d)c=i;else{d=Math.abs(d);e>d&&(e=d,c=i);for(;f+1<g;)if(h=Math.round((f+g)/2),i=a[h],d=b(i),0===d){c=i;break}else 0<d?f=h:g=h,d=Math.abs(d),e>d&&(e=d,c=i)}return c};
primitives.common.dependencies=function(){function a(a,b,c,d){var e,b=b[c];if(null!=b)for(e in b)if(b.hasOwnProperty(e)&&d.call(a,e,b[e]))break}function b(b,c,d,e,f,l){var n,m,s,q,p;if(null!=l){d=[];m={};for(n in f)f.hasOwnProperty(n)&&(m[n]=f[n]);for(n in c)c.hasOwnProperty(n)&&!m.hasOwnProperty(n)&&(m[n]=0,d.push(n));for(p=q=0;0<d.length;){s=[];f=0;for(e=d.length;f<e;f+=1){n=d[f];if(l.call(b,n,q,p)){s=[];break}q+=1;a(this,c,n,function(a){m[a]-=1;0===m[a]&&s.push(a)})}d=s;p+=1}}}var c={},d={},e=
...
primitives.common.family=function(a){function b(a,b,c,d){var e;if(null!=d&&(b=b[c],null!=b))for(e in b)if(b.hasOwnProperty(e)&&d.call(a,e))break}function c(a,b){var c=!1;null!=y[a]&&null!=y[a][b]&&(delete y[a][b],w[a]-=1,delete z[b][a],A[b]-=1,w[a]||(delete y[a],delete w[a]),z[b]||(delete z[b],delete A[b],null==u[null]&&(u[null]={},t[null]=0),u[null][b]=!0,t[null]+=1),c=!0);return c}function d(a,b){var c;if(null!=b)for(c in B)if(B.hasOwnProperty(c)&&b.call(a,c,B[c]))break}function e(a,c,d,e){for(var f,
g,h={},k=0,i=!0;i;){f={};i=!1;for(g in d)if(d.hasOwnProperty(g)&&!h[g])switch(h[g]=!0,e.call(a,g,B[g],k)){case 1:f={};i=!1;break;case 2:break;default:b(this,c,g,function(a){h[a]||(i=f[a]=!0)})}d=f;k+=1}}function f(a,b,c){null!=c&&null!=b&&(null!=B[b]&&null!=y[b])&&e(a,y,y[b],c)}function g(a,b,c){null!=c&&null!=b&&(null!=B[b]&&null!=z[b])&&e(a,z,z[b],c)}function h(a,c,d,e,f,g){var h,k,i,l;if(null!=g){c=[];k={};for(h in B)B.hasOwnProperty(h)&&(k[h]=d[h]||0,k[h]||c.push(h));for(l=0;0<c.length;){i=[];
d=0;for(f=c.length;d<f;d+=1){h=c[d];if(g.call(a,h,B[h],l)){i=[];break}l+=1;b(this,e,h,function(a){k[a]-=1;0===k[a]&&i.push(a)})}c=i}}}function i(a,b){h(a,z,A,y,w,b)}function j(a,b){h(a,y,w,z,A,b)}function k(a,b,c,d,e,f,g,h,k){var i=!1,l,j;if(null!=B[a]&&null!=g[a]){i=!0;if(k){k=0;for(l=b.length;k<l;k+=1)if(j=b[k],null==B[j]||null==g[a][j])i=!1}if(i&&(null!=d&&(B[c]=d),null!=B[c])){e[c]||(e[c]={},f[c]=0);g[c]||(g[c]={},h[c]=0);e[c][a]||(e[c][a]=!0,f[c]+=1);g[a][c]||(g[a][c]=!0,h[a]+=1);k=0;for(l=b.length;k<
l;k+=1)j=b[k],c!=j&&(null!=g[a][j]&&(delete g[a][j],h[a]-=1),null!=e[j][a]&&(delete e[j][a],f[j]-=1),e[j][c]||(e[j][c]=!0,f[j]+=1),g[c][j]||(g[c][j]=!0,h[c]+=1))}}return i}function l(a,b,c,d){return k(a,b,c,d,z,A,y,w,!0)}function n(){this.key=this.id="";this.children=[];this.childrenHash={};this.processed=!1}function m(a){this.items=[];this.difference=this.weight=0;0<arguments.length&&(this.difference=a)}function s(a){var c=primitives.common.graph(),d,e,f,g,h,k,i,l,j={};for(d in a)a.hasOwnProperty(d)&&
b(this,y,d,function(d){if(!j.hasOwnProperty(d)){j[d]=!0;e=[];b(this,z,d,function(a){e.push(a)});f=0;for(h=e.length;f<h-1;f+=1)if(k=e[f],a.hasOwnProperty(k))for(g=f+1;g<h;g+=1)if(i=e[g],a.hasOwnProperty(i)){l=Math.abs(a[k].children.length-a[i].children.length);var n=c.edge(k,i);null==n&&(n=new m(l),c.addEdge(k,i,n));n.items.push(d);n.weight+=1}}});return c}function q(a,b){this.parentid=a;this.childid=b;this.key=a+","+b}function p(a){return w[a]||0}function r(a){return A[a]||0}function x(a){var b=null,
a=y[a]||{};for(b in a)if(a.hasOwnProperty(b))return b;return null}function v(){return primitives.common.family({roots:u,rootsCount:t,children:y,childrenCount:w,parents:z,parentsCount:A,nodes:B})}var u={},t={},y={},w={},z={},A={},B={};primitives.common.isObject(a)&&(u=primitives.common.cloneObject(a.roots,!1),t=primitives.common.cloneObject(a.rootsCount,!0),y=primitives.common.cloneObject(a.children,!1),w=primitives.common.cloneObject(a.childrenCount,!0),z=primitives.common.cloneObject(a.parents,!1),
A=primitives.common.cloneObject(a.parentsCount,!0),B=primitives.common.cloneObject(a.nodes,!0));return{add:function(a,c,d){var e,f,g={};if(!a||0===a.length)a=[null];if(null==B[c]&&null!=d){B[c]=d;d=0;for(e=a.length;d<e;d+=1)f=a[d],null==g[f]&&f!=c&&(g[f]=!0,null!=B[f]?(null==z[c]&&(z[c]={},A[c]=0),z[c][f]||(z[c][f]=!0,A[c]+=1),null==y[f]&&(y[f]={},w[f]=0),y[f][c]||(y[f][c]=!0,w[f]+=1)):(null==u[f]&&(u[f]={},t[f]=0),u[f][c]||(u[f][c]=!0,t[f]+=1)));null!=u[c]&&(y[c]=u[c],w[c]=t[c],delete u[c],delete t[c],
b(this,y,c,function(a){null==z[a]&&(z[a]={},A[a]=0);z[a][c]||(z[a][c]=!0,A[a]+=1)}))}},adopt:function(a,b){var c,d,e;if(null!=B[b]){c=0;for(d=a.length;c<d;c+=1)if(e=a[c],null==z[b]&&(z[b]={},A[b]=0),e!=b&&null!=B[e])z[b][e]||(z[b][e]=!0,A[b]+=1),null==y[e]&&(y[e]={},w[e]=0),y[e][b]||(y[e][b]=!0,w[e]+=1);else throw"Item cannot be parent of itself and parent should exist in the structure!";}else throw"Child should be in hierarchy!";},bundleChildren:l,bundleParents:function(a,b,c,d){return k(a,b,c,d,
y,w,z,A,!0)},optimizeReferences:function(a){var c={},d={},e={},g,h,i,l,j,m;j=0;var p=10,q;if(null!=a){for(g in B)j+=1,B.hasOwnProperty(g)&&(h=new n,b(this,y,g,function(a){h.children.push(a);h.childrenHash[a]=!0}),h.children.sort(),h.id=g,h.key=h.children.join(","),e[h.id]=h);for(p=Math.pow(10,j.toString().length);!primitives.common.isEmptyObject(e);){i={};q={};l=s(e);for(g in e)e.hasOwnProperty(g)&&(j=e[g],j.processed||(m=l.getSpanningTree(g,function(a){return a.weight*p+p-a.difference}),m.loopLevels(this,
function(b,g){e[b].processed=!0;m.loopChildren(this,b,function(h,j){var m=l.edge(b,h),p=null,s,r,t,u,x,v;e[h].processed=!0;if(1<m.weight){r=m.items.join(",");if(c.hasOwnProperty(r))p=c[r];else{s=a();B[s.id]=s;p=new n;p.id=s.id;p.key=r;r=0;for(t=m.items.length;r<t;r+=1)v=m.items[r],p.children.push(v),p.childrenHash[v]=!0,q[v]=!0;p.children.sort();c[p.key]=p;d[p.id]=p;i[p.id]=p;q[p.id]=p;u=p.children.slice(0);f(this,g.replacementItem||b,function(a){!p.childrenHash[a]&&null!=d[a]&&(x=!0,f(this,a,function(a){if(!p.childrenHash[a])return x=
!1,1;if(!q.hasOwnProperty(a))return 2}),x&&u.push(a));return 2});k(g.replacementItem||b,u,p.id,s,z,A,y,w,!1);if(1>=(w[b]||0)&&null==g.replacementItem)g.replacementItem=p.id}if(p.id!=h&&(u=p.children.slice(0),f(this,j.replacementItem||h,function(a){null!=d[a]&&!p.childrenHash[a]&&(x=!0,f(this,a,function(a){return!p.childrenHash[a]?(x=!1,1):(q.hasOwnProperty(a),2)}),x&&u.push(a));return 2}),k(j.replacementItem||h,u,p.id,null,z,A,y,w,!1),1>=(w[h]||0)&&null==j.replacementItem))j.replacementItem=p.id}})})));
e=i}}},eliminateManyToMany:function(a){var c,d;for(c in y)y.hasOwnProperty(c)&&1<(w[c]||0)&&b(this,y,c,function(b){if(1<(A[b]||0))d=a(),l(c,[b],d.id,d)})},getPlanarFamily:function(a){var b=new primitives.common.family,c,d;a.loopLevels(this,function(e){var g=new primitives.common.LinkedHashItems,h={},k={},i=[];a.loopLevelItems(this,e,function(b){f(this,b,function(c){var d=a.getItemPosition(c),e=new q(b,c);k[e.key]=e;var f=[];g.isEmpty()?g.add(d,[e]):(g.iterateBack(function(a,c){if(c<d)return g.insertAfter(c,
d,[e]),!0;if(c==d)return a.push(e),!0;for(var h=0,k=a.length;h<k;h+=1){var i=a[h];i.parentid!=b&&f.push(i)}}),g.startKey()>d&&g.unshift(d,[e]));h[e.key]=f;for(var c=0,i=f.length;c<i;c+=1)h[f[c].key].push(e);return 2});if(1==p(b)){var c=x(b);1==r(c)&&(c=new q(b,c),i.push(c.key))}});var e=[],j,l;for(l in h){j=h[l];var m=j.length;null!=e[m]?e[m].push(l):e[m]=[l]}m={};e.unshift(i);for(var n=0,s=e.length;n<s;n+=1){var t=e[n];if(null!=t){c=0;for(d=t.length;c<d;c+=1)if(l=t[c],!m.hasOwnProperty(l)){m[l]=
!0;j=k[l];null==b.node(j.parentid)&&b.add(null,j.parentid,{});null==b.node(j.childid)?b.add([j.parentid],j.childid,{}):b.adopt([j.parentid],j.childid);j=h[l];l=0;for(var u=j.length;l<u;l+=1)m[j[l].key]=!0}}}});return b},removeNode:function(a){null!=B[a]&&(b(this,y,a,function(b){delete z[b][a];A[b]-=1;A[b]||(delete z[b],delete A[b],null==u[null]&&(u[null]={},t[null]=0),u[null][b]||(u[null][b]=!0,t[null]+=1))}),b(this,z,a,function(b){delete y[b][a];w[b]-=1;w[b]||(delete y[b],delete w[b])}),null!=u[null]&&
null!=u[null][a]&&(delete u[null][a],t[null]-=1,t[null]||(delete u[null],delete t[null])),delete y[a],delete w[a],delete z[a],delete A[a],delete B[a])},removeRelation:function(a,b){var d=!1;null!=B[a]&&null!=B[b]&&(d=c(a,b)||c(b,a));return d},node:function(a){return B[a]},loop:d,loopLevels:function(a,c,d){function e(){this.items={};this.minimumLevel=null}function f(a,b,c){var d=n[b];d||(d=new e,n[b]=d);d.addItemToLevel(a,c);u=null==u?c:Math.min(u,c);m[a]=c;k[a]=!0}var g=[],h={},k={},l=[],m={},n={},
p,s,q,r,t,u=null;q=c?i:j;var x,w,v,A,L,S,$,Y;e.prototype.addItemToLevel=function(a,b){var c=this.items[b];c?c.push(a):(c=[a],this.items[b]=c);this.minimumLevel=null==this.minimumLevel?b:Math.min(this.minimumLevel,b)};if(null!=d){q(this,function(a,b,c){g.push(a);h[a]=c});q=0;for(x=g.length;q<x;q+=1)if(p=g[q],null==k[p]){l.push(p);for(f(p,q,0);0<l.length;){L=A=v=null;S=!c;$=[];p=0;for(r=l.length;p<r;p+=1)t=l[p],w=m[t],Y=!1,c?(b(this,z,t,function(a){var b;if(!k[a]&&(Y=!0,b=h[a],null==v||!S||v<b||v==
b&&L>w-1))v=b,A=a,L=w-1,S=!0}),b(this,y,t,function(a){var b;if(!k[a]&&(Y=!0,b=h[a],null==v||!S&&(v>b||v==b&&L<w+1)))v=b,A=a,L=w+1,S=!1})):(b(this,y,t,function(a){var b;if(!k[a]&&(Y=!0,b=h[a],null==v||S||v<b||v==b&&L<w+1))v=b,A=a,L=w+1,S=!1}),b(this,z,t,function(a){var b;if(!k[a]&&(Y=!0,b=h[a],null==v||S&&(v>b||v==b&&L>w-1)))v=b,A=a,L=w-1,S=!0})),Y&&$.push(t);null!=A&&($.push(A),f(A,q,L));l=$}}l=!0;for(c=u;l;){p={};l=!1;for(s in n)if(n.hasOwnProperty(s)&&(q=n[s],r=q.items[q.minimumLevel-u+c],null!=
r)){p[s]=q;l=!0;q=0;for(x=r.length;q<x;q+=1)if(t=r[q],d.call(a,t,B[t],c-u))return l=!1,!0}n=p;c+=1}}},loopTopo:i,loopTopoReversed:j,loopChildren:f,loopParents:g,findLargestRoot:function(){var a=null,b,c={},d={},e;b=null;j(this,function(f,h){c.hasOwnProperty(f)||(c[f]={},d[f]=0);c[f][f]=!0;d[f]+=1;e=!0;g(this,h.id,function(a){var b,g;e=!1;c.hasOwnProperty(a)||(c[a]={},d[a]=0);if(!d[a]&&1==A[f])c[a]=c[f],d[a]=d[f];else for(g in b=c[f],b)b.hasOwnProperty(g)&&(c[a][g]=!0,d[a]+=1);return 2});if(e&&(!b||
d[f]>b))b=d[f],a=f});return a},loopRoots:function(a,b){var c=null,d,e=0,f={},h={},k,i={},l={},m,n,p,q,s,r,t;j(this,function(a,b){f.hasOwnProperty(a)||(f[a]={},h[a]=0);f[a][a]=!0;h[a]+=1;k=!0;g(this,b.id,function(b){var c,d;k=!1;f.hasOwnProperty(b)||(f[b]={},h[b]=0);if(!h[b]&&1==A[a])f[b]=f[a],h[b]=h[a];else for(d in c=f[a],c)c.hasOwnProperty(d)&&!f[b][d]&&(f[b][d]=!0,h[b]+=1);return 2});k&&(i[a]=!0,e+=1)});q={};for(p in i)if(i.hasOwnProperty(p))for(n in d=f[p],d)d.hasOwnProperty(n)&&(q[n]||(q[n]=
[]),q[n].push(p.toString()));for(;0<e;){d=null;for(m in i)if(i.hasOwnProperty(m)&&(!d||h[m]<d))d=h[m],c=m;if(null!=c){null!=b&&b.call(a,c,B[c]);d=f[c];for(n in d)if(d.hasOwnProperty(n)&&!l[n]){p=q[n];r=0;for(t=p.length;r<t;r+=1)s=p[r],h[s]-=1;l[n]=!0}delete i[c];e-=1}}},hasNodes:function(){return!primitives.common.isEmptyObject(B)},hasCommonChild:function(a){var c=!1,d,e,f,g,h,k,i;d={};g=f=0;for(h=a.length;g<h;g+=1)k=a[g],null!=B[k]&&!d[k]&&(d[k]=!0,f+=1);e={};for(k in d)d.hasOwnProperty(k)&&b(this,
y,k,function(a){e[a]=e[a]?e[a]+1:1});for(i in e)if(e.hasOwnProperty(i)&&null!=z[i]&&(A[i]||0)==e[i]&&e[i]==f){c=!0;break}return c},loopNeighbours:function(a,b,c){var d={};null!=c&&(f(this,b,function(b,e){d.hasOwnProperty(b)||(d[b]=null,c.call(a,b,e,1)&&(d[b]=2,g(this,b,function(b,e){d.hasOwnProperty(b)||(d[b]=null,c.call(a,b,e,2)&&(d[b]=2));return d[b]})));return d[b]}),g(this,b,function(b,e){d.hasOwnProperty(b)||(d[b]=null,c.call(a,b,e,1)&&(d[b]=2,f(this,b,function(b,e){d.hasOwnProperty(b)||(d[b]=
!0,c.call(a,b,e,2)&&(d[b]=2));return d[b]})));return d[b]}))},countChildren:p,countParents:r,firstParent:function(a){var b=null,a=z[a]||{};for(b in a)if(a.hasOwnProperty(b))return b;return null},firstChild:x,validate:function(a){function c(a){var b=0,d;if(null!=a)for(d in a)a.hasOwnProperty(d)&&(b+=1);return b}var e,f;d(this,function(c){b(this,y,c,function(b){if(!z.hasOwnProperty(b)||!z[b].hasOwnProperty(c))return null!=a&&(a.message="Child #"+b+" does not reference parent #"+c),!1});b(this,z,c,function(b){if(!y.hasOwnProperty(b)||
!y[b].hasOwnProperty(c))return null!=a&&(a.message="Parent #"+b+" does not reference child #"+c),!1})});for(e in z)if(z.hasOwnProperty(e)){if((A[e]||0)!=c(z[e]))return null!=a&&(a.message="Parents count for item #"+e+" missmatch."),!1;if(z.hasOwnProperty(e)&&!B.hasOwnProperty(e))return null!=a&&(a.message="Orphant parents for item #"+e),!1}for(f in y)if(y.hasOwnProperty(f)){if((w[f]||0)!=c(y[f]))return null!=a&&(a.message="Children count for item "+f+" missmatch."),!1;if(y.hasOwnProperty(f)&&!B.hasOwnProperty(f))return null!=
a&&(a.message="Orphant children of item "+f),!1}for(f in u)if(u.hasOwnProperty(f)){if((t[f]||0)!=c(u[f]))return null!=a&&(a.message="Root children count for item @"+f+" missmatch."),!1;b(this,u,f,function(b){if(!B.hasOwnProperty(b))return null!=a&&(a.message="Child #"+b+"of root #"+f+" does not exists."),!1})}return!0},hasLoops:function(){var a=v();i(this,function(b){a.removeNode(b)});return a.hasNodes()},clone:v,BREAK:1,SKIP:2}};
primitives.common.FibonacciHeap=function(a){function b(a){this.key=a.key;this.priority=a.priority;this.item=a.item}function c(a,b,c){this.key=a;this.priority=b;this.item=c;this.degree=0;this.marked=!1;this.right=this.left=this.child=this.parent=null}function d(a,b){var c=m[a.right];b.right=a.right;b.left=a.key;a.right=b.key;c.left=b.key}function e(a){var b=m[a.left],c=m[a.right];b.right=c.key;c.left=b.key;a.right=a.key;a.left=a.key}function f(){var a=null;null!=n&&(a=new b(m[n]));return a}function g(){var a=
f();if(null!=a){var b=m[n],c=m[b.right];if(null!=b.child){var d=m[b.child],g=m[d.left];b.right=d.key;c.left=g.key;d.left=b.key;g.right=c.key;e(b);delete m[b.key];n=null;h(d.key)}else e(b),delete m[b.key],n=null,c.key!=b.key&&h(c.key)}return a}function h(b){var c=[],d,e={};for(d=b;!e.hasOwnProperty(d);){var b=m[d],f=b.right;e[d]=!0;for(b.parent=null;null!=(d=c[b.degree]);)(a?b.priority>d.priority:b.priority<d.priority)?i(b,d):(i(d,b),b=d),c[b.degree-1]=null;c[b.degree]=b;if(null==n||null==m[n]||(a?
m[n].priority<=b.priority:m[n].priority>=b.priority))n=b.key;d=f}}function i(b,c){b.degree+=1;e(c);var f=m[b.child];if(null!=f){if(d(f,c),a?f.priority<c.priority:f.priority>c.priority)b.child=c.key}else b.child=c.key;c.parent=b.key}function j(b,c){var d=m[b];if(a?d.priority>c:d.priority<c)throw"Priority increase is not supported";d.priority=c;if(null!=d.parent){var e=m[d.parent];if(a?e.priority<d.priority:e.priority>d.priority)k(e,d),l(e)}if(a?m[n].priority<d.priority:m[n].priority>d.priority)n=d.key}
function k(a,b){b.marked=!1;b.parent=null;b.right==b.key?a.child=null:(a.child=b.right,e(b));a.degree-=1;d(m[n],b)}function l(a){if(null!=a.parent)if(a.marked){var b=m[a.parent];k(b,a);l(b)}else a.marked=!0}var n=null,m={};return{add:function(b,e,f){if(m.hasOwnProperty(b))throw"Duplicate keys are not supported!";e=new c(b,e,f);m[b]=e;if(null==n)e.left=b,n=e.right=b;else if(f=m[n],d(f,e),a?f.priority<e.priority:f.priority>e.priority)n=b},getPriority:function(a){var b=null;m.hasOwnProperty(a)&&(b=m[a].priority);
return b},setPriority:j,heapRoot:f,extractRoot:g,deleteKey:function(b){j(b,a?Infinity:-1);g()},validate:function(){var a=0,b;for(b in m)if(m.hasOwnProperty(b)){var c=m[b],a=a+1;if(null!=c.child){if(!m.hasOwnProperty(c.child))throw"Child does not exists";var d=m[c.child];if(d.parent!=c.key)throw"Child references wrong parent";}if(null!=c.parent&&!m.hasOwnProperty(c.parent))throw"Parent does not exists";if(null!=c.left){if(!m.hasOwnProperty(c.left))throw"Left does not exists";d=m[c.left];if(d.right!=
c.key)throw"Left references wrong right";}if(null!=c.right){if(!m.hasOwnProperty(c.right))throw"Right does not exists";d=m[c.right];if(d.left!=c.key)throw"Right references wrong left";}}if(null==n&&0<a)throw"Orphans";if(null!=n){if(!m.hasOwnProperty(n))throw"Root node does not exists";c=m[n];if(null!=c.parent)throw"Root node has parent reference";b=[n];c={};for(d=0;0<b.length;){for(var e=[],f=0,g=b.length;f<g;f+=1)for(var h=m[b[f]];!c.hasOwnProperty(h.key);)c[h.key]=!0,d+=1,null!=h.child&&e.push(h.child),
h=m[h.right];b=e}if(a!=d)throw"Tree has loops or orpants";}}}};
...
null==l?(f.add(j,k,null),h[j]=g.key.toString()):l<=k&&(f.setPriority(j,k),h[j]=g.key.toString()));e.add(h[g.key],g.key.toString(),{})}return e},getGrowthSequence:function(a){var d=[],e,f={},g;e=[];var h,i={},j=0,k,l,n,m,s,q;if(null!=a){e=null;n=0;m=null;for(h in b)if(b.hasOwnProperty(h)){l=b[h];n=0;for(k in l)l.hasOwnProperty(k)&&(n+=a(l[k]));if(n>m||null==m)e=h,m=n}if(null!=e){d.push(e);f[e]=!0;j+=1;for(i[e]=null;0<j;){e=[];l=k=null;n={};for(g in f)if(f.hasOwnProperty(g)){m=b[g];h=!1;for(s in m)if(m.hasOwnProperty(s)&&
!i.hasOwnProperty(s)&&(q=a(m[s]),h=!0,null==n[s]&&(n[s]=0),n[s]+=q,!l||n[s]>l))k=s,l=n[s];h||e.push(g)}if(null==k)break;else f[k]=!0,j+=1,i[k]=!0,d.push(k);h=0;for(k=e.length;h<k;h+=1)delete f[e[h]],j-=1}}}return d},getShortestPath:function(a,d,e,f,g){var h=primitives.common.FibonacciHeap(!1),i={},j={},k,l,n={},m=0,s=0,i=0;for(l=e.length;i<l;i+=1)k=e[i],n.hasOwnProperty(k)||(m+=1,n[k]=!0);h.add(d,0,null);for(j[d]=null;null!=(d=h.extractRoot());){e=b[d.key];for(k in e)e.hasOwnProperty(k)&&(l=d.priority+
(null!=f?f.call(a,e[k],d,k):1),i=h.getPriority(k),null!=i?i>l&&(h.setPriority(k,l),j[k]=d.key):j.hasOwnProperty(k)||(h.add(k,l,null),j[k]=d.key));if(n.hasOwnProperty(d.key)){i=[];for(e=d.key;null!=e;)i.push(e),e=j[e];g.call(a,i,d.key);s+=1;if(s>=m)break}}}}};
primitives.common.LinkedHashItems=function(){function a(a,b){if(e.hasOwnProperty(a))throw"Duplicate segments are not supported!";e[a]=b;f[a]=null;null==i?(h=a,g[a]=null):(f[i]=a,g[a]=i);i=a}function b(a,b){if(e.hasOwnProperty(a))throw"Duplicate segments are not supported!";e[a]=b;g[a]=null;null==h?(i=a,f[a]=null):(g[h]=a,f[a]=h);h=a}function c(a,b,c,d){var m;null==c&&(c=a?h:i);if(null!=b)for(;null!=c;){m=e[c];if(null!=m&&b(m,c))break;c=c==d?null:a?f[c]:g[c]}}function d(a,b,d){c(!0,a,b,d)}var e={},
...
b.resolve(d.dependencies,d.factory)());c.push(d)});f&&console.log("-- process --");for(var h={},i=0,j=c.length;i<j;i+=1){var k=c[i],l=[];if(k.name==d||h.hasOwnProperty(k.name)){if(f)var n=performance.now();(g=k.task.process(f))&&a.loopChildren(this,k.name,function(b){h[b]=!0;f&&l.push(b);return a.SKIP});if(f)var m=performance.now();if(f){var s=Math.round(m-n,2);console.log(i+". "+k.name+(", "+s+" ms. ")+(g?" - forces: "+l.toString():""))}}if(k.name==e)break}},getProcessDiagramConfig:function(){var d=
...
d.restore()};primitives.pdf.graphics.prototype.rightAngleLine=function(){};primitives.pdf.graphics.prototype.template=function(a,b,c,d,e,f,g,h,i,j,k,l,n){c=0;null!==n&&void 0!==n["border-width"]&&(c=this.getPxSize(n["border-width"]));a=new primitives.common.Rect(a+e,b+f,g-c,h-c);null==l&&(l=new primitives.common.RenderEventArgs);null!==k&&k(this._doc,a,l)};
